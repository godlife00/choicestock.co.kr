$(document).ready(function () {
    ...
    */
    ...
    // 텍스트 에니메이션 클래스 랜덤부여    
    // var AniDelay = 2000;
    // var AniClass = 'Re_fresh';
    // setInterval(function() {       
    //     var random = Math.floor(Math.random() * 4);        
    //     $('.globalStock .main_mid.attention_area table.tableRanking.type_2Line td.title + td.num').eq(random).addClass(AniClass).delay(AniDelay).queue(function(){
    //         $(this).removeClass(AniClass).dequeue();
    //     });
    // },AniDelay);
});