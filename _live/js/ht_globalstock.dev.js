    ...
    $.ajax({
        ...
        success : function(data) {
            if(data.success) {
                ...
                location.href='/ht_stock/catch_info?catch_list='+data.catch_list+'&sector_list='+data.sector_list;
            }
            else {
                alert(data.msg);
                location.href='/ht_stock/catch_info';
            }
        }
    });
}
...
function fnCatchNewSave() {
	...
	$('#loading').css("display", "block");
	location.href='/ht_stock/catch_process?catchType='+catchType+'&catchSize='+catchSize+'&catchSector='+catchSec;
}
...
function fnMyTickerSave() {
    ...
    location.href= '/ht_main/saveTicker?ticker='+ticker;
}
...
function fnMyitem(ticker, page, count, id) {
    ...
    var href = '/ht_search/setTicker/'+ticker+'/'+count;
...
function moveToSearch(div) {
    ...
    if ($('li a._on', div).length > 0) {
        ...
        location.href = '/ht_search/summary/' + keyword;
    } else {
...
function onSearchTicker(ticker) {
    ...
    location.href = '/ht_search/summary/' + ticker;
}
...
function setSearchHistory(keyword) {
    ...
    */
    ...
    $.ajax({
        url: '/ht_main/ajax_save_search_history',
        type: 'GET',
        data: { 'ticker': keyword },
        async: false,
        success: function () {
