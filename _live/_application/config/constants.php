...
if(IS_REAL_SERVER) {
    $allow_domains = array(
        ...
        'mirae.choicestock.co.kr'  => 'mirae',
        'eugene.choicestock.co.kr'  => 'eugene',
        'demo.choicestock.co.kr'  => 'demo',
        'wowtv.choicestock.co.kr'  => 'wowtv',
        'sk.choicestock.co.kr'  => 'sk',
    );
    ...
    define('API_URL', 'https://us-api.datahero.co.kr');
    ...
    define('VALUE_HOME', 'https://value.choicestock.co.kr');
    define('SUPER_HOME', 'https://super.choicestock.co.kr');
    ...
    define('VALUE_HOME', 'https://vdev.choicestock.co.kr');
    define('SUPER_HOME', 'https://sdev.choicestock.co.kr');
...
define('HTTPS_ADMIN_URL','https://'.ADMIN_DOMAIN);
...
define('MR_INC_PATH', APP_PATH.'/_application/views/'.MR.'/inc');
define('SK_INC_PATH', APP_PATH.'/_application/views/'.SK.'/inc');
define('HN_INC_PATH', APP_PATH.'/_application/views/'.HN.'/inc');
define('EG_INC_PATH', APP_PATH.'/_application/views/'.EG.'/inc');
define('WT_INC_PATH', APP_PATH.'/_application/views/'.WT.'/inc');
...
/*한경TV로그인Id, Key값*/
define('WT_APP_ID', 'fc081aa32e384dd5b9081216be627d50');
define('WT_APP_KEY', '4d9pVYhL9996JX1ADAm7D6SLmYNOL2Jb+LGNsiUxsVc=');
define('WT_APP_TYPE', '15');
define('WT_API_URL', 'https://swbillapi.wowtv.co.kr');
define("WT_ENC_KEY", 'W*WTV@DATAHERO');
//define('WT_API_URL', 'https://devswbillapi.wowtv.co.kr');
define('DEV_WT_API_URL', 'https://devswbillapi.wowtv.co.kr');
