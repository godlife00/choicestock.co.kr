...
class Menu
{
    public function get_header_contents($template='1', $data=array()) {
		...
		*/
		...
		$back_html = '<img src="/img/icon_back.svg" alt="뒤로가기">';
...
//echo '<pre>'; print_r($data['header_data']);
		...
		/*
        $search_img_name = 'icon_search.svg';
        if(in_array($template, array('10','14'))) {
            $search_img_name = 'icon_search.svg';
        }
		*/
        //if($template != '5') {
        if(!in_array($template, array('1','5','10','11','13','16','20'))) {
	        $header_top_html .= '<a href="/main/search" class="go_sch"><img src="/img/icon_search.svg" alt="검색하기"></a>';
		}
		...
		if($template == '10') {
	        ...
	        $header_top_html .= '<a href="/stock/alarm" class="alarm"><img src="/img/icon_alarm.png" alt="알림">'.$add_html.'</a>';
		}
