...
class Wt_attractiveness extends Wt_BaseMobile_Controller {
    ...
    public function index() {
        $this->common->locationhref('/'.WT.'_attractiveness/attractive');
    ...
    public function attractive() {
        ...
        $data['content_html'] = $this->load->view('/'.WT.'/attractiveness/attractive_list.php', array('list' => $result['list']), true);

        $this->header_data['header_template'] = '7';
        $this->header_data['head_title'] = '전종목 투자 매력도';

        $data['meta_title'] = '미국주식창 | 투자매력도 ';
    ...
    public function ajax_get_attractive_list() {
        ...
        $result = $this->_get_attractive_data();
        $content_html = $this->load->view('/'.WT.'/attractiveness/attractive_list.php', array('list' => $result['list']), true);
        echo $content_html;
        return;
    }
