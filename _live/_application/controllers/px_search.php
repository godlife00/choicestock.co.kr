...
class Px_search extends Px_BaseMobile_Controller {
    ...
    public function index() {
        $this->common->locationhref('/'.PX.'_main');
    }
    ...
    private function _general_data($ticker, $dimension='MRY', $option=array()) {
        ...
        if(sizeof($recom_data) > 0) {
            ...
            $data['recom_link'] = '/'.PX.'_stock/recommend_view/'.$recom['rc_id'];
        }
/*
        // 종목추천에 등록된 ticker 인지 확인
...
*/
        //$data['meta_title'] = $data['ticker']['tkr_name'].'/'.$ticker.' | 팍스초이스';
...
*/
        ...
        $data['ticker_header'] = $this->load->view('/'.PX.'/search/ticker_header', $data, true);
...
/*차트*/
        ...
        $data['meta_title'] = $data['ticker']['tkr_name'].' '.$ticker.' | 투자매력 - 팍스초이스';
    ...
    public function competitor($ticker) {
		...
		*/
        ...
        $data['meta_title'] = $data['ticker']['tkr_name'].' '.$ticker.' | 경쟁사 - 팍스초이스';
...
//$data['ticker_unit'] = 0;
        ...
        $data['meta_title'] = $data['ticker']['tkr_name'].' '.$ticker.' | 기업개요 - 팍스초이스';
    ...
    public function finance_chart($ticker, $dimension='MRY') {
        ...
        */
        ...
        $data['meta_title'] = $data['ticker']['tkr_name'].' '.$ticker.' | 재무차트 - 팍스초이스';
...
*/
    ...
    public function alloca($ticker) {
        ...
        $data['meta_title'] = $data['ticker']['tkr_name'].' '.$ticker.' | 배당 - 팍스초이스';
