...
class Eg_attractiveness extends Eg_BaseMobile_Controller {
    ...
    public function index() {
        $this->common->locationhref('/'.EG.'_attractiveness/attractive');
    ...
    public function attractive() {
        ...
        $data['content_html'] = $this->load->view('/'.EG.'/attractiveness/attractive_list.php', array('list' => $result['list']), true);
    ...
    public function ajax_get_attractive_list() {
        ...
        $result = $this->_get_attractive_data();
        $content_html = $this->load->view('/'.EG.'/attractiveness/attractive_list.php', array('list' => $result['list']), true);
        echo $content_html;
        return;
    }
