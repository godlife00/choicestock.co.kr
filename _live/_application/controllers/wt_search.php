...
class Wt_search extends Wt_BaseMobile_Controller {
    function __construct() {
        parent::__construct();

        //if($this->partner_info['part_name'] != 'mirae') {
        //$this->paramCheck();
        //}
    ...
    private function _general_data($ticker, $dimension='MRY', $option=array()) {
        ...
        if(sizeof($recom_data) > 0) {
            ...
            $data['recom_link'] = '/'.WT.'_stock/recommend_view/'.$recom['rc_id'];
        }

		//$data['meta_title'] = $data['ticker']['tkr_name'].'/'.$ticker.' | 미국주식창';
		...
		//$data['applist'] = ($this->is_iphone===TRUE) ? $this->globalIosApp:$this->globalApp;
		$data['applist'] = ($this->session->userdata('user_ostype') == 'I') ? $this->globalIosApp:$this->globalApp;
    ...
    public function news($ticker='') {
        ...
        $data['ticker_header'] = $this->load->view('/'.WT.'/search/ticker_header', $data, true);

        $data['meta_title'] = $data['ticker']['tkr_name'].' '.$ticker.'('.$data['ticker']['tkr_name_en'].') | 뉴스 - 미국주식창';
    ...
    public function ajax_get_news_list() {
        ...
        echo $this->load->view('/'.WT.'/search/news_list', $list_data, true);
    }
    ...
    public function news_view($ticker='', $no=0) {
        ...
        $this->header_data['back_url'] = '/'.WT.'_search/news/'.$ticker;
        //$this->header_data['back_url'] = '/';
		$data['meta_title'] = $row['n_title'].' | 뉴스 - 미국주식창';
        //$data['meta_title'] = $data['ticker']['tkr_name'].' '.$ticker.'('.$data['ticker']['tkr_name_en'].') | 뉴스 - 미국주식창';
    ...
    public function fairvalue($ticker='AAPL') {
        ...
        $data['meta_title'] = $data['ticker']['tkr_name'].' '.$ticker.'('.$data['ticker']['tkr_name_en'].') | 적정주가 - 미국주식창';
...
//$data['ticker_unit'] = 0;
        ...
        $data['meta_title'] = $data['ticker']['tkr_name'].' '.$ticker.'('.$data['ticker']['tkr_name_en'].') | 개요 - 미국주식창';
...
/*차트*/
        ...
        $data['meta_title'] = $data['ticker']['tkr_name'].' '.$ticker.' | 투자매력 - 미국주식창';
    ...
    public function competitor($ticker) {
        ...
        $data['meta_title'] = $data['ticker']['tkr_name'].' '.$ticker.' | 경쟁사 - 미국주식창';
    ...
    public function finance_chart($ticker, $dimension='MRY') {
        ...
        */
        ...
        $data['meta_title'] = $data['ticker']['tkr_name'].' '.$ticker.' | 재무차트 - 미국주식창';
...
*/
    ...
    public function financials($ticker, $dimension='MRT') {
        ...
        */
        ...
        $data['meta_title'] = $data['ticker']['tkr_name'].' '.$ticker.'('.$data['ticker']['tkr_name_en'].') | 재무제표 - 미국주식창';
    ...
    public function invest($ticker, $dimension='MRT') {
        ...
        $data['meta_title'] = $data['ticker']['tkr_name'].' '.$ticker.'('.$data['ticker']['tkr_name_en'].') | 투자지표 - 미국주식창';
    ...
    public function alloca($ticker='AAPL') {
        $this->common->locationhref('/'.WT.'_search/dividend/'.$ticker);
		exit;
	}
    ...
    public function dividend($ticker='AAPL') {
        ...
        $data['meta_title'] = $data['ticker']['tkr_name'].' '.$ticker.' | 배당 - 미국주식창';
	...
	protected $globalIosApp = array (
		'0' => array('img' => '', 'url' => ''),
		'1' => array('img' => 'kiwoom', 'url' => 'https://itunes.apple.com/kr/app/id387842606?mt=8'),
		'2' => array('img' => 'mirae', 'url' => 'https://itunes.apple.com/kr/app/id1248716281?mt=8'),
		'3' => array('img' => 'samsung', 'url' => 'https://itunes.apple.com/kr/app/id1150231646?mt=8'),
		'4' => array('img' => 'nh', 'url' => 'https://itunes.apple.com/kr/app/id486312400?mt=8'),
		'5' => array('img' => 'truefriend', 'url' => 'https://itunes.apple.com/kr/app/id1166032655?mt=8'),
		'6' => array('img' => 'daishin', 'url' => 'https://itunes.apple.com/kr/app/id558783357?mt=8'),
		'7' => array('img' => 'ebest', 'url' => 'https://itunes.apple.com/kr/app/id978618686?mt=8'),
		'8' => array('img' => 'yuanta', 'url' => 'https://itunes.apple.com/kr/app/id653424753?mt=8'),
		'9' => array('img' => 'eugene', 'url' => 'https://itunes.apple.com/kr/app/id1080300592?mt=8'),
	);

	protected $globalApp = array (
		'0' => array('img' => '', 'url' => ''),
		'1' => array('img' => 'kiwoom', 'url' => 'intent://kiwoomherosghost?Menu=0144&Code=000020&Source=1#Intent;scheme=kiwoomherosg;action=android.intent.action.VIEW;category=android.intent.category.BROWSABLE;launchFlags=0x30000000;package=com.daou.herosw;end'),
		'2' => array('img' => 'mirae', 'url' => 'intent://content?menuId=wld.stock.quote#Intent;scheme=miraeassetGlobal;package=com.miraeasset.global;end'),
		'3' => array('img' => 'samsung', 'url' => 'https://play.google.com/store/apps/details?id=com.samsungpop.android.mpop'),
		'4' => array('img' => 'nh', 'url' => 'https://play.google.com/store/apps/details?id=com.wooriwm.txsmart'),
		'5' => array('img' => 'truefriend', 'url' => 'Intent://content?menuNum=0806&openData=STOCK_ORDER^SEP2^071050^SEP2^0#Intent;scheme=eFriendNeoSmarta;package=com.truefriend.neosmarta;end'),
		'6' => array('img' => 'daishin', 'url' => 'intent://com.daishin.creon?menu=913 #Intent;scheme=creonmainapp;package=com.daishin.creon;end'),
		'7' => array('img' => 'ebest', 'url' => 'intent://content?type=2230#Intent;scheme=smartapp;action=android.intent.action.VIEW;category=android.intent.category.BROWSABLE;package=com.ebest.mobile;end'),
		'8' => array('img' => 'yuanta', 'url' => 'intent://tradarm#Intent;scheme=yuanta;package=com.yuanta.tradarm;end'),
		'9' => array('img' => 'eugene', 'url' => 'Intent://eugenesmartchampion2?openscreen=1611opendata=#CODE#^1#Intent;scheme=com.eugenefn.smartchampion2;package=com.eugenefn.smartchampion2;end'),
	);
}
