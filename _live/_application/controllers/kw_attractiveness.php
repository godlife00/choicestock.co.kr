...
class Kw_attractiveness extends Kw_BaseMobile_Controller {
    ...
    public function index() {
        $this->common->locationhref('/'.KW.'_attractiveness/attractive');
    ...
    public function attractive() {
        ...
        $data['content_html'] = $this->load->view('/'.KW.'/attractiveness/attractive_list.php', array('list' => $result['list']), true);

        $this->header_data['header_template'] = '7';
        $this->header_data['head_title'] = '전종목 투자 매력도';

        $data['meta_title'] = '투자매력도 - 미주미초이스';
    ...
    public function ajax_get_attractive_list() {
        ...
        $result = $this->_get_attractive_data();
        $content_html = $this->load->view('/'.KW.'/attractiveness/attractive_list.php', array('list' => $result['list']), true);
        echo $content_html;
        return;
    }
