...
require_once dirname(__FILE__).'/ht_base_mobile.php';
class Ht_search extends Ht_BaseMobile_Controller {
    function __construct() {
        parent::__construct();

        //if($this->partner_info['part_name'] != 'hantoo') {
        //$this->paramCheck();
        //}
    ...
    public function index() {
        $this->common->locationhref('/'.HT.'_main');
    }
    ...
    private function _general_data($ticker, $dimension='MRY', $option=array()) {
        ...
        if(sizeof($recom_data) > 0) {
            ...
            $data['recom_link'] = '/'.HT.'_stock/recommend_view/'.$recom['rc_id'];
        }
    ...
    public function news($ticker='') {
        ...
        $data['ticker_header'] = $this->load->view('/'.HT.'/search/ticker_header', $data, true);
    ...
    public function ajax_get_news_list() {
        ...
        echo $this->load->view('/'.HT.'/search/news_list', $list_data, true);
    }
    ...
    public function news_view($ticker='', $no=0) {
        ...
        $this->header_data['back_url'] = '/'.HT.'_search/news/'.$ticker;
        //$this->header_data['back_url'] = '/';
...
*/
    ...
    public function alloca($ticker='AAPL') {
        $this->common->locationhref('/'.HT.'_search/dividend/'.$ticker);
		exit;
	}
