...
class Hn_attractiveness extends Hn_BaseMobile_Controller {
    ...
    public function index() {
        $this->common->locationhref('/'.HN.'_attractiveness/attractive');
    ...
    public function attractive() {
        ...
        $data['content_html'] = $this->load->view('/'.HN.'/attractiveness/attractive_list.php', array('list' => $result['list']), true);
    ...
    public function ajax_get_attractive_list() {
        ...
        $result = $this->_get_attractive_data();
        $content_html = $this->load->view('/'.HN.'/attractiveness/attractive_list.php', array('list' => $result['list']), true);
        echo $content_html;
        return;
    }
