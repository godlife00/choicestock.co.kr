...
abstract class Sk_BaseMobile_Controller extends CI_Controller {
...
//https://sk.choicestock.co.kr/sk_main?serviceYN=Y&customNo=SUY4UUs3M1JKTmhSTFREL0NVa1F2dz09
    }
...
//서비스소개 : "https://sk.choicestock.co.kr/sk_main/service"  + &serviceYN="Y 또는 N" &customNo="고객번호"
//홈 :  "https://sk.choicestock.co.kr/sk_main" + &serviceYN="Y 또는 N" &customNo="고객번호"
//customNo : SUY4UUs3M1JKTmhSTFREL0NVa1F2dz09
        $pt_session = $this->input->get('serviceYN');
        $pt_usernum = $this->input->get('chcust');
...
/*
		SEED
		암호화키 : rototics+yyyymmdd
		12345678 -> MSXQ3aq9eXeqOBz3TyTtXw==
		qwerasdf -> DHLi2ZOt/0epYnwCE2vbMQ==
...
*/
    ...
    protected function payCheck(){
        if(!$this->session->userdata('is_paid')){
			...
			//echo '}';			
			echo '</script>';
            $this->common->locationhref('/sk_main');
            exit;
		}
    }
...
/* remove
                ...
                case 'member/notice':
                    ...
                    break;
remove */
                case SK.'_main/myticker':
                    $show_menu = false;
                case SK.'_main/onestop':
                case SK.'_main/search':
                    $container_class = 'sub_search schfix_inc';
                    $show_type = '2';
                    $is_searching = true;
                    $searching_title = '진단';
                    break;
                case SK.'_stock/recommend':
                    $header['header_class'] = ' h_sub';
                ...
                case SK.'_stock/recommend_view':
                    ...
                    $is_sicon = false;
                    break;
                case SK.'_stock/analysis':
                    $header['header_class'] = ' h_sub';
                    $container_class = 'sub_analysis';
                    $show_type = '2';
                    //$is_vt_banner = TRUE;
                    break;
                case SK.'_stock/analysis_view':
                    $container_class = 'sub_analysis';
                    $show_type = '2';
                    break;
                case SK.'_stock/winner':
                    $header['header_class'] = ' h_sub';
                ...
                case SK.'_stock/vod_view':
                    ...
                    $back_url = 'vod';
                    break;
                case SK.'_search/news_view':
                case SK.'_stock/research_view':
                    $container_class = 'sub_research';
                    $show_type = '2';
                    $is_headtop = true;
                    $headtop_title = '탐구생활';
                    $is_sicon = false;
                    break;
                case SK.'_stock/morning_view':
                case SK.'_stock/morning':
                ...
                case SK.'_stock/catch_info':
                    ...
                    $searching_title = '발굴';
                    break;
                case SK.'_search/primary_ticker':
                case SK.'_search/news':
                case SK.'_search/fairvalue':
                case SK.'_search/invest_charm':
                case SK.'_search/summary':
                case SK.'_search/finance_chart':
                case SK.'_search/invest':
                case SK.'_search/financials':
                case SK.'_search/dividend':
                case SK.'_search/competitor':
                    $show_type = '2';
                    ...
                    //$back_url = 'recommend';
                    break;
                case SK.'_attractiveness/attractive':
                    $header['header_class'] = ' h_sub';
                    $show_type = '2';
                ...
                case SK.'_main/menu':
                    ...
                    break;
                case SK.'_main/service':
                case SK.'_main/service_guide':
                case SK.'_main/service_prm':
                    $show_type = '3';
                    //$is_vt_banner = TRUE;
...
//remove        case 'payment/pay_free':
		...
		*/
        ...
        if( ! $return_contents) {
            ...
            $this->load->view('/'.SK.'/inc/header.php', $header);
            $this->load->view('/'.SK.'/'.$view.'.php', $data);
            $this->load->view('/'.SK.'/inc/footer.php', $footer);
        } else {

            //if($data['chkUri']!='sk') {
            $result  = $this->load->view('/'.SK.'/inc/header.php', $header, true)."\n";
            $result .= $this->load->view('/'.SK.'/'.$view.'.php', $data, true)."\n";
            //}
            $result .= $this->load->view('/'.SK.'/inc/footer.php', $footer, true)."\n";
            return $result;
        }
    }
