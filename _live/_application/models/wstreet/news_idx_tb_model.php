...
class News_idx_tb_model extends MY_Model {

	protected $pk = 'ni_id';

	// NOT NULL 필드들에대한 정의. 각 모델에서 재정의
	protected $emptycheck_keys = array(
		'ni_code' => 'ni_code value is empty.',
		'ni_title' =>  'ni_title value is empty.',
		'ni_table' =>  'ni_table value is empty.',
		'ni_pk' => 'ni_pk value is empty.',
		'ni_ticker' => 'ni_ticker value is empty.',
	);
