        ...
        ?>
            <div class="sub_top view">
                <div class="chart_area">
                    <div class="chartData">
                        <h2 class="title" title="<?=$rc_data['ticker']['tkr_name_en']?>"><a href="/<?=EG?>_search/summary/<?=$rc_data['rc_ticker']?>"><?=$rc_data['ticker']['tkr_name']?></a></h2>
                        <a href="/<?=EG?>_search/summary/<?=$rc_data['rc_ticker']?>" class="more"><img src="/img/more_Black.png" alt="더보기"></a>
                        <ul class="info">
                    ...
                    <div class="tab_container">
                        ...
                        <div id="tab1" class="tab_content">
							...
							<div class="one_step">
                                ...
                                <a href="/<?=EG?>_stock/recommend/portfolio" class="more"><span>포트폴리오</span></a>
                            </div>
                            <div class="catalyst">
                                ...
                                <div>
                                    ...
                                    <div class="bandchart_more">
                                        <p><a href="/<?=EG?>_stock/recommend/portfolio#more"><i></i>종목추천&amp;포트폴리오 운영안내 >></a></p>          
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="tab2" class="tab_content">
                            ...
                            <a href="/<?=EG?>_search/invest_charm/<?=$rc_data['rc_ticker']?>" class="more"><img src="/img/more_Black.png" alt="더보기"></a>
                            ...
                            <div class="data_table">
                                ...
                                <a href="/<?=EG?>_search/invest/<?=$rc_data['rc_ticker']?>" class="more"><img src="/img/more_Black.png" alt="더보기"></a>
                                <!-- 수익성(연환산) -->
                                <div>
                                    <table cellspacing="0" border="1" class="tableRanking">
                                        <colgroup>
