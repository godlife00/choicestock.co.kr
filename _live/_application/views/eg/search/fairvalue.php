                ...
                <div class="prm_div weeks_free">
                    <div class="box">
                        ...
                        <div class="right">
                            ...
                            <p><a href="/<?=EG?>_main/service" class="go_link">[서비스 안내]</a></p>
                        </div>
                    </div>
                </div>
<?php else :?>
...
<?php if($sec_ticker=='' && $pri_ticker=='') {?>
			...
			<?php endif;?>
				...
				<div class="bandchart_sume" id="more">
                    ...
                    <div class="box">
                        <p class="title">초이스스탁US의 적정주가 밴드차트는</p>
                        <ul>
                    ...
                    <a href="/<?=EG?>_stock/vod_view/93" class="youtube_link"><i></i>매매 타이밍을 쉽게 잡을 수 있는 적정주가 매매전략</a>
                </div>
                <!-- //bandchart_sume -->
            </div>
            <!-- //sub_mid -->
