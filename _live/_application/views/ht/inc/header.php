...
<head>
    ...
    <?php if($this->session->userdata('is_hts')===FALSE) :?>
    <script type="text/javascript" src="//cdnjs.cloudflare.com/ajax/libs/jqueryui-touch-punch/0.2.3/jquery.ui.touch-punch.min.js"></script>
	<?php endif;?>
    <link rel="canonical" href="https://hantoo.choicestock.co.kr">
    <!-- css -->
        ...
        <div id="header" class="header main_hdr">
            ...
            <div class="main_searching">
                ...
                <div class="searchArea">
                    <form action=""  name="topsearch" onsubmit="var v = $('#autocomplete_list li a._on span.schCode').html(); if(v.length > 0 && $('#autocomplete_list').get(0).children.length > 0) { this.action='/<?=HT?>_search/summary/'+v; setSearchHistory(v); return true; }; return false;">
                        <fieldset>
        ...
        <div id="header" class="header">
            <div class="headerTop">
                ...
                <?php if($this->session->userdata('is_paid')===TRUE) :?>
					...
					<a href="/<?=HT?>_main/menu" class="his_back"><img src="/img/icon_back.svg" alt="뒤로가기"></a>
					<?php elseif($back_url=='recommend') :?>
					<a href="/<?=HT?>_stock/recommend" class="his_back"><img src="/img/icon_back.svg" alt="뒤로가기"></a>
					<?php elseif($back_url=='none') :?>
					<?php else :?>
					<a href="javascript:history.back(-1);" class="his_back"><img src="/img/icon_back.svg" alt="뒤로가기"></a>
					<?php endif;?>
				<?php else :?>
					<a href="/<?=HT?>_main" class="his_back"><img src="/img/icon_back.svg" alt="뒤로가기"></a>
				<?php endif;?>

                <?php if($is_sicon === true):?>
                <div class="hm">
	                <a href="/<?=HT?>_main/search" class="go_sch"><img src="/img/icon_search.svg" alt="검색하기"></a>
                </div>
                <?php endif;?>
