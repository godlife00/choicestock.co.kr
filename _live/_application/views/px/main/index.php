			<div class="paxtitle_area">
                <h1 class="pax_logo" ><img src="/img/logo_pax.svg" alt="팍스초이스"></h1>                
                <p class="pax_txt">미국주식 쉽고 편리하게!</p>
            </div>
            <!-- //paxtitle_area -->
            ...
            <div class="main_top recommend_area">
                <h3 class="title"><a href="/<?=PX?>_stock/recommend">종목추천</a></h3>
                <a href="/<?=PX?>_stock/recommend" class="more"><img src="/img/more_Black.png" alt="더보기"></a>
                ...
                ?>
                    <div class="chart_area">
                        <div class="chartData">
                            ...
                            <a href="javascript:fnPay();"><?=iconv_substr($val['ticker']['tkr_name'], 0, 1, 'utf-8')?><span class="remark"><div class="txt_filter size_B"><i></i><i></i><i></i><i></i></div></span>
                            <?php else :?>
                            <a href="/<?=PX?>_stock/recommend_view/<?=$val['rc_id']?>"><?=$val['ticker']['tkr_name']?>
                            <?php endif;?>
                            </a></h4>
                            <ul class="info">
                        ...
                        <div class="chartGoal">
                            <dl>
                                ...
                                <?php else :?>
                                <dd class="prm_lock"><a href="javascript:fnPay();"><img src="/img/prm_lockB_red.png" alt="잠김"></a></dd>
                                <?php endif;?>
                            </dl>
                            <dl>
                                <dt>수익률</dt>
                ...
                <div class="ptfo_recom">
                    ...
                    <a href="/<?=PX?>_stock/recommend/portfolio" class="more">종목 <span><?=$pf_count?>개</span><img src="/img/more_Black.png" alt="더보기"></a>
                </div>
					...
					<table cellspacing="0" border="1" class="tableRanking ptfo_table">
						<tbody>
							...
							<tr>
								...
								<a href="javascript:fnPay();"><?=iconv_substr($portfolio['tkr_name'], 0, 1, 'utf-8')?><span class="remark"><div class="txt_filter size_M"><i></i><i></i><i></i><i></i></div></span></a>
								<?php else :?>
									<a href="/<?=PX?>_stock/recommend_view/<?=$portfolio['rc_id']?>"><?=$portfolio['tkr_name']?></a>
								<?php endif;?>
								</td>
								<td class="num">
                ...
                <div class="main_mid game_area">
                    <h3 class="title"><a href="/<?=PX?>_stock/winner">승부주</a> <span class="remark">- 스탁히어로 알고리즘 종목추천</span></h3>
                    <a href="/<?=PX?>_stock/winner" class="more"><img src="/img/more_Black.png" alt="더보기"></a>
                        ...
                        <table cellspacing="0" border="0" class="tableRanking type_2Line">
                            ...
                            <?php $win=0; foreach($winner_list as $winner) :?>
                                ...
                                <tr>
                                    ...
                                    <a href="/<?=PX?>_search/invest_charm/<?=$winner['win_ticker']?>"><?=$winner['tkr_name']?><span class="ticker"><?=$winner['win_ticker']?>
                                    <?php else :?>
                                    <a href="javascript:fnPay();"><?=iconv_substr($winner['tkr_name'], 0, 1, 'utf-8')?><span class="remark"><div class="txt_filter size_M"><i></i><i></i><i></i><i></i></div></span><span class="ticker"><span class="remark"><div class="txt_filter size_S"><i></i><i></i><i></i><i></i></div></span></span>
                                    <?php endif;?>
                                    </span></a>
                                    </td>
                                    <td class="num">
                                    ...
                                    <?php else :?>
                                    <td class="prm_lock"><span><a href="javascript:fnPay();"><img src="/img/prm_lock_red.png" alt="잠김"></a></span></td>
                                    <?php endif;?>
                ...
                <?php include_once PX_INC_PATH.'/main_contents_banner.php'; ?>
            ...
            <div class="main_mid attention_area">
                <h3 class="title"><a href="/<?=PX?>_main/search">관심종목</a></h3>
                <a href="/<?=PX?>_main/search" class="more"><img src="/img/more_Black.png" alt="더보기"></a>
               ...
               <?php //if(is_array($recommend) && sizeof($recommend) > 0) : ?>
                ...
                <div class="swiper-container attentionSwiper">
                    ...
                    ?>
                            ...
                            <?php endif;?>
                                        <tr>
                                            <td class="title"><a href="/<?=PX?>_search/invest_charm/<?=$val['ticker']['tkr_ticker']?>"><?=$val['ticker']['tkr_name']?><span class="ticker"><?=$val['ticker']['tkr_ticker']?></span></a>
                                            </td>
                                            <td class="num">
                                            ...
                                            <?php //else :?>
                                            <!--<td class="prm_lock"><span><a href="/main/service_prm"><img src="/img/prm_lock_red.png" alt="잠김"></a></span></td>-->
                                            <?php //endif;?>
                                        </tr>
                    ...
                    <?php if($this->session->userdata('is_paid')===TRUE) :?>
						<div class="swiper-slide">
                            <div class="attention_all">
                                <a href="/<?=PX?>_main/search">관심종목 전체보기 <i></i></a>
                            </div>                            
                        </div>
                        <!-- //swiper-slide -->    
                    <?php endif;?>
                ...
                <div class="one_step">
                    ...
                    <a href="/<?=PX?>_main/onestop" class="more"><span>원스톱 진단</span><img src="/img/more_yel.png"
                            alt="더보기"></a>
                </div>
                <!-- //one_step -->
            ...
            <div class="main_mid catch_area">
                <div class="bg_box">
                    <h3 class="title"><a href="/<?=PX?>_stock/catch_info">종목캐치</a></h3>
                    <p class="txt">나의 취향에 맞는 종목</p>
                    <a href="/<?=PX?>_stock/catch_info" class="more"><img src="/img/more_white.png" alt="더보기"></a>
                </div>
                <!-- //bg_box -->
                ...
                <div class="list_area d01">
                    <div class="swiper-container catchSwiper">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <ul class="list">
                                    <li class="title"><a href="/<?=PX?>_search/invest_charm/<?=$val['ticker']['tkr_ticker']?>"><?=$val['ticker']['tkr_name']?><span class="ticker"><?=$val['ticker']['tkr_ticker']?></span></a></li>
                                    <li class="num">
                                        <span><?=$this->common->set_pricepoint($val['ticker']['tkr_close'], '1')?></span>
                                        <span class="<?=$class?>"><?=$this->common->set_pricepoint($val['ticker']['tkr_rate_str'], '2')?></span>
                                    </li>
                ...
                <div class="prm_div weeks_free">
                    <div class="box">
                        ...
                        <div class="right">
                            <p><a href="/<?=PX?>_stock/catch_info" class="btn_free">추천종목 확인<i></i></a></p>
                        </div>
                    </div>
                </div>
                <?php endif;?>
            ...
            <div class="main_mid event_recipe">
                <h3 class="title"><a href="/<?=PX?>_stock/recipe_intro">투자레시피</a></h3>
                <a href="/<?=PX?>_stock/recipe_intro" class="more"><img src="/img/more_Black.png" alt="더보기"></a>
                        ...
                        <div id="tab1" class="tab_content">
                            <div class="tableth_box">
                                ...
                                <table cellspacing="0" border="0" class="tableRanking type_2Line">
									...
									<?php if($rc>4) break;?>
                                        <tr>
                                            <td class="title t_short"><a href="/<?=PX?>_search/invest_charm/<?=$val['tkr_ticker']?>"><?=$val['tkr_name']?><span class="ticker"><?=$val['tkr_ticker']?></span></a></td>
                                            <td class="num">
                            ...
                            <div class="tableth_box">
                                ...
                                <table cellspacing="0" border="0" class="tableRanking type_2Line">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="title"><a href="/<?=PX?>_search/invest_charm/<?=$row['m_ticker']?>"><?=$row['m_korname']?><span class="ticker"><?=$row['m_ticker']?></span></a>
                                            </td>
                                            <td class="num">
            ...
            <div class="main_btm banner_area">
                <!-- //banner -->
                <?php include_once PX_INC_PATH.'/main_banner1.php'; ?>
                <!-- //banner -->
            </div>
            <!-- //main_btm //recipe_area -->

            <div id="footer" style="display: block; opacity: 1; position: relative; top: 20px; padding-top: 15px;">            
                <style>
                    #footer .notice .copyright,
                    #footer .notice .home_page {font-size: 0.8rem; line-height: 1.5rem;}
                </style>
                <div class="notice">                
                    <div class="foot_info">                    
                        <p class="copyright" style="margin-top: 0;"><a href="https://www.datahero.co.kr" target="_blank">㈜팍스넷</a><i></i>
                            <strong>대표이사</strong> 고성웅 <i></i> 서울시 강남구 논현로 803 <strong> <i></i> 사업자등록번호 202-81-63804</strong> <i></i> 대표번호 1688-5010
                        </p>
                    </div>
                    <!-- //foot_info -->    
