            ...
            <div class="sub_top">
                <div class="">
                    <div class="txt_box">
                        <p class="txt">
                            미국주식 6,000여개 기업에 대한 투자매력도 순위를 제공합니다. 투자매력 포인트가 높을 수록 우량 기업입니다.
            ...
            <div class="sub_mid attract_sub">
                <div class="set">
					...
					<a href="#setting" data-modal="modal-5" class="md-trigger btn_schSet button"><i></i>정렬</a>
               </div>
                ...
                <table cellspacing="0" border="1" class="tableRanking attract_table">
                    ...
                    <tbody id="attractive_list">
                        <tr>
							<th class="title">종목명</th>
                            <th class="">종합<?=($sort == 'total') ? '<i></i>' : ''?><br><br>
                ...
                function view_more() {
                    ...
                    var url = '/<?=WT?>_attractiveness/ajax_get_attractive_list';
                ...
                <?php else :?>
                <?php /*$move='Y';*/ include_once WT_INC_PATH.'/premium_banner.php'; ?>
                <?php endif;?>
            </div> <!-- //sub_mid -->
            ...
            <div class="md-modal md-effect-3" id="modal-5">
                ...
                <div id="setting" class="setting_area">
                    <div class="pop_header">
                        <a href="#setting_anchor" title="닫기" class="close"><img src="/img/clse.png" alt="팝업닫기"></a>
                    ...
                    <div class="pop_con">
                        ...
                        <form id="search_form" action="/<?=WT?>_attractiveness/attractive" method="GET">
