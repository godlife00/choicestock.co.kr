                                ...
                                <div class="chart_area">
                                    <div class="chartData">
                                        <div class="left">
                                            ...
                                            <a href="#" data-modal="modal-3" class="btn_free md-trigger"><?=iconv_substr($r['ticker']['tkr_name'], 0, 1, 'utf-8')?><span class="remark"><div class="txt_filter size_M"><i></i><i></i><i></i><i></i></div></span>
                                            <?php else :?>
                                            <a href="/<?=WT?>_stock/recommend_view/<?=$r['rc_id']?>"><?=$r['ticker']['tkr_name']?>
                                            <?php endif;?>
                                            ...
                                            <ul class="info">
                                                ...
                                                <?php else :?>
                                                <a href="/<?=WT?>_stock/recommend_view/<?=$r['rc_id']?>">
                                                <?php endif;?>                                                
                                    ...
                                    <div class="chartGoal">
										...
										<span class="attainment attainment_com sub_cut"><span>교체매도 </span> <i class="<?=($r['rc_profit_rate']>0) ? 'increase':'decrease'?>"><?=($r['rc_profit_rate']>0) ? '+':''?><?=number_format($r['rc_profit_rate'],2)?><b>%</b></i></span>
										<?php else :?>
...
<?php }else{?>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <?php else :?>
                                            <td class="prm_lock"><span><img src="/img/prm_lockW.png" alt="잠김"></span></td>
                                            <?php endif;?>                                            
                                            <td class="num">
