                        ...
                        <dl>
                            <dt class="charm">투자매력
                                ...
                                <div class="guide_box _hide">
                                    ...
                                    <ul>
                                        <li class="list_txt">투자매력 점수는 높을수록 매력적인 기업이며, 65점(상위 20%) 이상이면 우량 기업으로 판단합니다.</li>
                                        <li class="list_txt">투자매력 세부 항목인 독점력, 수익성, 안전성, 현금창출력, 미래성장성으로 별점(★) 5점 만점에 3점 이상이면 각 항목을 통과한 것으로 판단합니다.</li>
                        ...
                        <table cellspacing="0" border="1" class="tableRanking table_alloca">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="num">
                                        <?php if($part_page!='et') :?><a href="/<?=WT?>_attractiveness/attractive?sort=future&netincome=all&marketcap=over100billion"><?php endif;?><!--<span>상위 <?=$future_rank_rate?>%</span>--><?php if($part_page!='et') :?></a><?php endif;?>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="title">
                                    ...
                                    <td class="num">
                                        <?php if($part_page!='et') :?><a href="/<?=WT?>_attractiveness/attractive?sort=moat&netincome=all&marketcap=over100billion"><?php endif;?><!--<span>상위 <?=$moat_rank_rate?>%</span>--><?php if($part_page!='et') :?></a><?php endif;?>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="title">
                                    ...
                                    <td class="num">
                                <?php if($part_page!='et') :?><a href="/<?=WT?>_attractiveness/attractive?sort=safety&netincome=all&marketcap=over100billion"><?php endif;?><!--<span>상위 <?=$safety_rank_rate?>%</span>--><?php if($part_page!='et') :?></a><?php endif;?>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="title">
                                    ...
                                    <td class="num">
                                        <?php if($part_page!='et') :?><a href="/<?=WT?>_attractiveness/attractive?sort=growth&netincome=all&marketcap=over100billion"><?php endif;?><!--<span>상위 <?=$growth_rank_rate?>%</span>--><?php if($part_page!='et') :?></a><?php endif;?>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="title">
                                    ...
                                    <td class="num">
                                        <?php if($part_page!='et') :?><a href="/<?=WT?>_attractiveness/attractive?sort=cashflow&netincome=all&marketcap=over100billion"><?php endif;?><!--<span>상위 <?=$cashflow_rank_rate?>%</span>--><?php if($part_page!='et') :?></a><?php endif;?>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="search_ptfo">
							...
							<?php if(is_array($portfolio_list) && sizeof($portfolio_list) > 0) :?>
								...
								<div class="free_choicestock">
									<p><a href="#" data-modal="modal-3" class="btn_free md-trigger">종목 확인하기</a> - 미국주식창 무료체험 <i></i></p>                            
								</div>
							<?php endif;?>
							<!-- //ptfo_recom -->
						</div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="chart_area">
                                            <div class="chartData">
                                                ...
                                                <span class="chart_name"><?php if($part_page == ''){?><a href="/<?=WT?>_search/summary/<?=$row['m_ticker'];?>"><?php }?><?=$row['m_korname']?> (<?=$row['m_ticker']?>)<?php if($part_page == ''){?></a><?php }?></span>
                                                ...
                                                <div class="chart_star">
                                                    ...
                                                    <!-- //star_area -->
                                                    <?php if($part_page == ''){?><a href="/<?=WT?>_search/summary/<?=$row['m_ticker']?>" class="more">자세히 <i>>></i> </a><?php }?>
                                                </div>
                                                <!-- //chart_star -->
                                            </div>
                                        </div>
...
<?php }else{?>
        ...
        <div class="sub_mid nondata">
            <p class="nodata_guide"><strong><?=$sec_ticker;?></strong>의 상세 기업정보는 <strong><?php if($part_page == ''){?><a href="/<?=WT?>_search/summary/<?=$pri_ticker?>"><?php }?><?=$pri_ticker?><?php if($part_page == ''){?></a><?php }?></strong> 종목에서 확인할 수 있습니다.</p>
        </div>
        <!-- //sub_mid nondata -->
<?php }?>
...
/* 
	...
	<div id="container" class="sub_search">
		<!-- 주요 콘텐츠 -->
		<div class="sub_mid nondata">
			<p class="nodata_guide"><strong>입력하신 종목은 종목진단 서비스를 제공하지 않습니다.</strong></p>
		</div>
		<!-- //sub_mid nondata -->
*/
?>
