			<div class="ptfo_recom">
				...
				<a href="/<?=SK?>_stock/recommend/portfolio" class="more">종목 <span><?=$pf_count?>개</span><img src="/img/more_Black.png" alt="더보기"></a>
				<?php else:?>
					...
					<tbody>
						...
						<tr>
							...
							<!--<a href="javascript:fnSinChung();"><?=iconv_substr($portfolio['tkr_name'], 0, 1, 'utf-8')?><span class="remark"><div class="txt_filter size_M"><i></i><i></i><i></i><i></i></div></span></a>-->
								<a href="/<?=SK?>_stock/recommend_view/<?=$portfolio['rc_id']?>"><?=$portfolio['tkr_name']?></a>
							</td>
							<td class="num">
