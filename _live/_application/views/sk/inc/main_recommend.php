...
<?php endif;?>			
            <div class="main_top recommend_area">
                <h3 class="title"><a href="/<?=SK?>_stock/recommend">종목추천</a></h3>
				<?php if($this->session->userdata('is_paid')===TRUE) :?>
				<a href="/<?=SK?>_stock/recommend" class="more"><img src="/img/more_Black.png" alt="더보기"></a>
				<?php endif;?>
						...
						?>
                            <div class="swiper-slide">
                                <div class="area">
                                    <ul class="list">
										<?php if($this->session->userdata('is_paid')===TRUE) :?>
                                        <li class="title"><a href="/<?=SK?>_stock/recommend_view/<?=$val['rc_id']?>"><?=$val['ticker']['tkr_name']?></a></li>
