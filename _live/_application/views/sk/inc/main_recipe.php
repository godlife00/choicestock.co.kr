                    ...
                    <div class="tab_container">
                            ...
                            <div class="tableth_box">
                                ...
                                <table cellspacing="0" border="0" class="tableRanking type_2Line">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="title t_short"><a href="/<?=SK?>_search/summary/<?=$val['ticker']['tkr_ticker']?>"><?=$val['ticker']['tkr_name']?><span class="ticker"><?=$val['ticker']['tkr_ticker']?></span></a></td>
											<td class="num">
                                ...
                                <div class="table_btmarea">
                                    <a href="/<?=SK?>_stock/recipe/soaring" class="more">더보기<i></i></a>
                                </div>
								<?php endif;?>
                                <!-- //table_btmarea -->
                            </div>
                            ...
                            <div class="tableth_box">
                                ...
                                <table cellspacing="0" border="0" class="tableRanking type_2Line">
									...
									<?php if($rc>3) break;?>
                                        ...
                                        <tr>
                                            <td class="title t_short"><a href="/<?=SK?>_search/summary/<?=$val['tkr_ticker']?>"><?=$val['tkr_name']?><span class="ticker"><?=$val['tkr_ticker']?></span></a></td>
                                            <td class="num">
								...
								<?php if($this->session->userdata('is_paid')===TRUE) :?>
                                <div class="table_btmarea">
                                    <a href="/<?=SK?>_stock/recipe/earnings" class="more">더보기<i></i></a>
                                </div>
								<?php endif;?>
                                <!-- //table_btmarea -->
                            </div>
                        ...
                        <div id="tab3" class="tab_content">
                            <div class="tableth_box">
								...
								<?php if($this->session->userdata('is_paid')===TRUE) :?>
                                <div class="table_btmarea">
                                    <a href="/<?=SK?>_stock/recipe/interest" class="more">더보기<i></i></a>
                                </div>
								<?php endif;?>
                                <!-- //table_btmarea -->
                            </div>
                        ...
                        <div id="tab4" class="tab_content">
                            <div class="tableth_box">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
											...
											<?php if($this->session->userdata('is_paid')===FALSE) :?>
												...
												<?php else :?>
												<a href="/<?=SK?>_search/summary/<?=$row['m_ticker']?>"><?=$row['m_korname']?><span class="ticker"><?=$row['m_ticker']?></span></a>
												<?php endif;?>
											</td>
                                            <td class="num">
								...
								<?php if($this->session->userdata('is_paid')===TRUE) :?>
                                <div class="table_btmarea">
                                    <a href="/<?=SK?>_stock/recipe/dividend" class="more">더보기<i></i></a>
                                </div>
								<?php endif;?>
                                <!-- //table_btmarea -->
                            </div>
