				<?=($part_page != 'et') ? $ticker_header:''?>
<?php if($is_exist) {?>
<?php if($sec_ticker=='' && $pri_ticker=='') {?>
				<div class="sub_mid outline_box">
					<?php if($part_page == 'et') :?>
					<a href="callScreenMethod://OpenScreen?param=2313;https://hana.choicestock.co.kr/<?=HN?>_search/invest_charm/<?=$ticker_code?>" class="box">
					<?php else:?>
					<a href="/<?=HN?>_search/invest_charm/<?=$ticker_code?>" class="box">
					<?php endif;?>
						<p class="title"><span>종목진단점수</span></p>
						<div class="con">
					...
					<?php if($fairvalue_rate >= -5) :?>
						...
						<?php if($part_page == 'et') :?>
						<a href="callScreenMethod://OpenScreen?param=2313;https://hana.choicestock.co.kr/<?=HN?>_search/fairvalue/<?=$ticker_code?>" class="box">
						<?php else:?>
						<a href="/<?=HN?>_search/fairvalue/<?=$ticker_code?>" class="box">
						<?php endif;?>
						...
						<?php else :?>
						<a href="javascript:fnSinChung();" class="box">
							<p class="title"><span>AI적정주가</span></p>
							<div class="con">
								<div class="value_chart">                                                    
									<div class="prm_lock"><span><i></i>초이스스탁US 신청하기</span></div>
									<div class="line">                  
										<span class="g_action" style="left: 50%;"></span>                                              
									</div>
									<div class="adequate">
				...
				<?php endif;?>
					...
					<?php if($part_page == 'et') :?>
					<a href="callScreenMethod://OpenScreen?param=2313;https://hana.choicestock.co.kr/<?=HN?>_search/invest/<?=$ticker_code?>" class="box">
					<?php else:?>
					<a href="/<?=HN?>_search/invest/<?=$ticker_code?>" class="box">
					<?php endif;?>
					...
					<div class="box">
						<p class="title">
						<?php if($part_page == 'et') :?>
						<a href="<?=($this->session->userdata('is_paid')===TRUE || $open_ticker===TRUE)? 'callScreenMethod://OpenScreen?param=2313;https://hana.choicestock.co.kr/'.HN.'_stock/recipe_intro':'javascript:;'?>">
						<?php else:?>
						<a href="<?=($this->session->userdata('is_paid')===TRUE || $open_ticker===TRUE)? '/'.HN.'_stock/recipe_intro':'javascript:;'?>">
						<?php endif;?>						
						투자레시피</a></p>
						<div class="con">
							<div class="event_attractiveness">
								...
								<?php if($part_page == 'et') :?>
									...
									<li class="att_on"><a href="<?=($this->session->userdata('is_paid')===TRUE || $open_ticker===TRUE)? 'callScreenMethod://OpenScreen?param=2313;https://hana.choicestock.co.kr/'.HN.'_stock/recipe/dividend':'javascript:;'?>">배당매력주</a></li>
									<?php $at_count++; endif; ?>

									<?php if($mri_data['m_future_score'] >= 16) : ?>
									<li class="att_on"><a href="<?=($this->session->userdata('is_paid')===TRUE || $open_ticker===TRUE)? 'callScreenMethod://OpenScreen?param=2313;https://hana.choicestock.co.kr/'.HN.'_stock/recipe/growth':'javascript:;'?>">이익성장주</a></li>
									<?php $at_count++; endif; ?>

									<?php if($mri_data['m_biz_moat_score'] >= 16) : ?>
									<li class="att_on"><a href="<?=($this->session->userdata('is_paid')===TRUE || $open_ticker===TRUE)? 'callScreenMethod://OpenScreen?param=2313;https://hana.choicestock.co.kr/'.HN.'_stock/recipe/moat':'javascript:;'?>">소비자독점주</a></li>
									<?php $at_count++; endif; ?>
								...
								<?php else :?>
									<?php $at_count = 0; if($mri_data['m_biz_dividend_score'] >= 16) : ?>
									<li class="att_on"><a href="<?=($this->session->userdata('is_paid')===TRUE || $open_ticker===TRUE)? '/'.HN.'_stock/recipe/dividend':'javascript:;'?>">배당매력주</a></li>
									<?php $at_count++; endif; ?>

									<?php if($mri_data['m_biz_growth_score'] >= 16) : ?>
									<li class="att_on"><a href="<?=($this->session->userdata('is_paid')===TRUE || $open_ticker===TRUE)? '/'.HN.'_stock/recipe/growth':'javascript:;'?>">이익성장주</a></li>
									<?php $at_count++; endif; ?>

									<?php if($mri_data['m_biz_moat_score'] >= 16) : ?>
									<li class="att_on"><a href="<?=($this->session->userdata('is_paid')===TRUE || $open_ticker===TRUE)? '/'.HN.'_stock/recipe/moat':'javascript:;'?>">소비자독점주</a></li>
									<?php $at_count++; endif; ?>
					...
					<?php if($this->session->userdata('is_paid')===TRUE || $open_ticker===TRUE) :?>
						<?php if($part_page == 'et') :?>
						<a href = "callScreenMethod://OpenScreen?param=2313;https://hana.choicestock.co.kr/<?=HN?>_search/competitor/<?=$ticker_code?>" class="box">
						<?php else:?>
						<a href="/<?=HN?>_search/competitor/<?=$ticker_code?>" class="box">
						<?php endif;?>
					<?php else :?>
					<a href="javascript:fnSinChung();" class="box">
					<?php endif;?>
                ...
                <div class="sub_mid financials_chart">
                    ...
                    <!-- //tabletabs_wrap -->
					<?php if($part_page == 'et' && $this->session->userdata('is_paid') === false) :?>
...
<?php }else{?>
	...
	<div id="container" class="sub_search">
		<!-- 주요 콘텐츠 -->
		<div class="sub_mid nondata">
			<p class="nodata_guide"><strong>입력하신 종목은 개요 서비스를 제공하지 않습니다.</strong></p>
		</div>
		<!-- //sub_mid nondata -->
<?php }?>