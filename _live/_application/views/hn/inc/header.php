        ...
        <div id="header" class="header main_hdr">
            ...
            <div class="main_searching">
                ...
                <div class="searchArea">
                    <form action=""  name="topsearch" onsubmit="var v = $('#autocomplete_list li a._on span.schCode').html(); if(v.length > 0 && $('#autocomplete_list').get(0).children.length > 0) { this.action='/<?=HN?>_search/summary/'+v; setSearchHistory(v); return true; }; return false;">
                        <fieldset>
        ...
        <div id="header" class="header">
            <div class="headerTop">
                ...
                <?php if($this->session->userdata('is_paid')===TRUE) :?>
					...
					<a href="/<?=HN?>_main/menu" class="his_back"><img src="/img/icon_back.svg" alt="뒤로가기"></a>
					<?php elseif($back_url=='recommend') :?>
					<a href="/<?=HN?>_stock/recommend" class="his_back"><img src="/img/icon_back.svg" alt="뒤로가기"></a>
					<?php elseif($back_url=='none') :?>
					<?php else :?>
					<a href="javascript:history.back(-1);" class="his_back"><img src="/img/icon_back.svg" alt="뒤로가기"></a>
					<?php endif;?>
				<?php else :?>
					<a href="/<?=HN?>_main" class="his_back"><img src="/img/icon_back.svg" alt="뒤로가기"></a>
				<?php endif;?>
                ...
                <div class="hm">
                    ...
                    <?php else :?>
                        <a href="/<?=HN?>_main/search" class="go_sch"><img src="/img/icon_search.svg" alt="검색하기"></a>
                    <?php endif;?>
                </div>
                <?php endif;?>
