            <div class="sub_mid latest_results">
                <div class="tabsArea">
                    <ul class="tabs tabs_two">
                        <li class="active" rel="tab1"><a href='/<?=HN?>_main/search'>관심종목</a></li>
                        <li rel="tab2">인기종목</li>
                    </ul>
                    ...
                    <div class="tab_container">
                        ...
                        <div id="tab1" class="tab_content">
                            ...
                            <div class="onestep_guide">
                                ...
                                <a href="/<?=HN?>_main/search" class="more"><span>관심종목</span><img src="/img/more_white.png" alt="더보기"></a>
...
<?php //iconv_substr($val['ticker']['tkr_name'], 0, 1, 'utf-8')?>
                                        ...
                                        <script>
                                            var value = [{
                                                data: [
                                                    ...
                                                    <?php $careful .= '<li><a href="/'.HN.'_search/summary/'.$val['ticker']['tkr_ticker'].'">'.$ticker_name.'</a></li>'."\n"?>
                                                    <?php $is_careful = TRUE?>
                                                    <?php endif;?>
                                                    <?php if($val['m_biz_total_score']>=65 && $val['ticker']['tkr_close'] < $val['m_v_fairvalue2']) :?>
                                                    <?php if($is_careful === FALSE):?>
                                                    <?php $hopeful .= '<li><a href="/'.HN.'_search/summary/'.$val['ticker']['tkr_ticker'].'">'.$ticker_name.'</a></li>'."\n"?>
                                                    <?php endif;?>
                                                    <?php endif;?>
                                                    <?php endforeach;?>
                                                ]
                            ...
                            <table cellspacing="0" border="0" class="tableRanking type_2Line">
                                ...
                                ?>
                                    <tr>
                                        <td class="title"><a href="/<?=HN?>_search/summary/<?=$val['ticker']['tkr_ticker']?>"><?=$val['ticker']['tkr_name']?><span class="ticker"><?=$val['ticker']['tkr_ticker']?></span></a></td>
                                        <td class="num">
                            ...
                            <!--<div class="one_step">
                                ...
                                <a href="/<?=HN?>_stock/catch_info" class="more"><span>종목 캐치</span><img src="/img/more_yel.png" alt="더보기"></a>
                            </div>-->
                        </div>
                            ...
                            <table cellspacing="0" border="0" class="tableRanking type_2Line">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <?php else :?>
                                        <td class="prm_lock">
                                            <span><a href="/<?=HN?>_main/service"><img src="/img/prm_lock.png" alt="잠김"></a></span>
                                        </td>
                                        <?php endif;?>
                                    </tr>
                                <?php endforeach; ?>
