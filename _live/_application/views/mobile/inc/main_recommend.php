                            ...
                            <div class="swiper-slide">
                                <div class="area">
                                    <ul class="list">
                                        ...
                                        <li class="title"><a href="/stock/recommend_view/<?=$val['rc_id']?>"><?=$val['ticker']['tkr_name']?></a></li>
                                        <li class="sum"><?=$val['ticker']['tkr_ticker']?></li>
										<?php else:?>
                                        <li class="title"><a href="#" data-modal="<?=($is_event === true) ? 'modal-4':'modal-3'?>" class="btn_free md-trigger"><?=iconv_substr($val['ticker']['tkr_name'], 0, 1, 'utf-8')?><span class="remark"><div class="txt_filter size_M"><i></i><i></i><i></i><i></i></div></span></a></li>
                                        ...
                                        <li class="num">
                                            <div>
												...
												<?php else :?>
                                                <span class="td prm_lock"><a href="#" data-modal="<?=($is_event === true) ? 'modal-4':'modal-3'?>" class="btn_free md-trigger"><img src="/img/prm_lockW.png" alt="잠김"></a></span>
												<?php endif;?>
                                            </div>
                                            <div>
