...
<?php if($this->session->userdata('is_paid')===FALSE && $open_ticker===FALSE) :?>
                <div class="prm_div weeks_free">
                    <div class="box">
                        ...
                        <div class="right">
                            <p>
                                <a href="#" data-modal="modal-3" class="btn_free md-trigger">[ <?=($this->session->userdata('is_login') === TRUE) ? '첫 달 3,000원!':'2주 무료보기'?>]<i></i></a>
                            </p>
                            <p><a href="/main/service" class="go_link">[서비스 안내]</a></p>
                        </div>
                    </div>
                </div>
<?php else :?>
...
<?php if($sec_ticker=='' && $pri_ticker=='') {?>
			...
			<?php endif;?>
				...
				<div class="bandchart_sume" id="more">
                    ...
                    <a href="/stock/vod_view/93" class="youtube_link"><i></i>매매 타이밍을 쉽게 잡을 수 있는 적정주가 매매전략</a>
                </div>
                <!-- //bandchart_sume -->
            </div>
            <!-- //sub_mid -->
