			...
			//추석 연휴 이벤트 => 날짜 : 9/20(월) AM10:00 ~ 9/23(목) AM9:00
			$is_holiday = FALSE;
			if(date('YmdH') >= '2021092010' && date('YmdH') < '2021092310' ) {
				$is_holiday = TRUE;
			}			
			?>
            ...
            <div class="sub_top">
                <div class="">
                    <div class="txt_box">
						<p class="txt">알고리즘에 따라 투자 로봇이 매일 5종목을 추천합니다. 종목발굴의 용도로 활용하실 수 있습니다. 실시간 리딩은 제공하지 않습니다. <span class="guide">(*추천가 대비 10% 하락시 손절매도)</span></p>
                            ...
                            <div class="game_list">
                                ...
                                <div class="list">
                                    <div class="game_event">
                                        ...
                                        <div class="title">
										<?php if($this->session->userdata('is_paid')===TRUE || ($win==0 && $cnt==0) || $is_holiday === TRUE) :?>
										<a href="/search/summary/<?=$winner['win_ticker']?>"><?=$winner['tkr_name']?>
										<?php else :?>
										<a href="#" data-modal="<?=($is_event === true) ? 'modal-4':'modal-3'?>" class="btn_free md-trigger"><?=iconv_substr($winner['tkr_name'], 0, 1, 'utf-8')?><span class="remark"><div class="txt_filter size_M"><i></i><i></i><i></i><i></i></div></span>
										<?php endif;?>
										</a></div>
                                        <div class="num">
