			...
			<?php if($this->session->userdata('is_paid')===TRUE) :?>
                ...
                <div class="chart_catch">
                    <div class="data_area">
                        <h2 class="title"><a href="/search/summary/<?=$ticker['tkr_ticker']?>"><?=$ticker['tkr_name']?></a></h2>
                        <ul class="info">
					...
					<span class="same_selt"><a href="/search/summary/<?=$choice_ticker?>"><?=$choice_name?></a>와(과) 같은 업종입니다</span>
					<?php endif;?>
                </div>
                <!-- //chart_catch -->
				<?php $idx++; endforeach;?>
					<?php if($is_next === true) :?>
					<div class="next"><a href="/stock/<?=($is_file===true)? 'add_catch2':'add_catch'?>?mode=auto&idx=<?=$idx?>&page=1" class="nextPage">다음 페이지</a></div>
					<?php endif;?>
				<?php else :?>
				...
				<div class="prm_div weeks_free">
					<div class="box">
						...
						<div class="right">
							...
							<?php else:?>
							<p><a href="/member/login" class="btn_free">2주 무료보기<i></i></a></p>
							<?php endif;?>
						</div>
					</div>
				</div>
