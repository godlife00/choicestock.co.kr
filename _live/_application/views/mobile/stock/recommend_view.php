        ...
        ?>
            <div class="sub_top view">
                <div class="chart_area">
                    <div class="chartData">
                        <h2 class="title" title="<?=$rc_data['ticker']['tkr_name_en']?>"><a href="/search/summary/<?=$rc_data['rc_ticker']?>"><?=($rc_data['ticker']['tkr_name']) ? $rc_data['ticker']['tkr_name']:$rc_data['rc_korname']?></a></h2>
                        <a href="/search/summary/<?=$rc_data['rc_ticker']?>" class="more"><img src="/img/more_Black.png" alt="더보기"></a>
                        <ul class="info">
                            <li class="sum"><span class="eng"><?=$rc_data['rc_ticker']?></span> </li>
							<?php if($rc_data['rc_portfolio'] == 'Y') :?><li class="port">포트편입</li><?php endif;?> 
                        </ul>
                        <!-- //info -->
						<?php if($rc_data['rc_isdelisted'] == 'Y') :?>
                        <ul class="detail">
                            <span style="color: #FF2E2E; font-size: 0.875rem;">상장폐지</span>                            
                        </ul>
						<?php else :?>
                        <ul class="detail">
							<?php if($is_wowinfo === true) : ?>
							<li class="num">
								<span id='last_price'><?=$this->common->set_pricepoint(number_format($wval['last_price'], 2), '1')?></span>
							</li>
							<li class="per">
							...
							<li class="day" id='price_date'><?=($wval['status'] == '0') ? date('y.m/d H:i', strtotime($wval['updated_at'])) : date('y.m/d', strtotime($wval['updated_at']))?>, USD</li>
							<?php else :?>
                        ...
                        <div class="detail_data">
                            ...
                            <div class="attainment_box loss_cut">
                ...
                <div class="tabsArea">
                    ...
                    <div class="tab_container">
                        ...
                        <div id="tab1" class="tab_content">
							...
							<?php $rc_data['rc_invest_point'] = str_replace('_blank','_self',$rc_data['rc_invest_point']);?>
							<?php endif;?>
							...
							<div class="one_step">
                                ...
                                <a href="/stock/recommend/portfolio" class="more"><span>포트폴리오</span></a>
                            </div>
                            <div class="catalyst">
                                <h4 class="title">유의사항</h4>
                                <div>
                                    <p><i>①</i>종목 추천은 주 5회(월~금) 진행합니다.</p>
                                    ...
                                    <div class="bandchart_more">
                                        <p><a href="/stock/recommend/portfolio#more"><i></i>종목추천&amp;포트폴리오 운영안내 >></a></p>          
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="tab2" class="tab_content">
                            ...
                            <a href="/search/invest_charm/<?=$rc_data['rc_ticker']?>" class="more"><img src="/img/more_Black.png" alt="더보기"></a>
                            ...
                            <div class="data_table">
                                ...
                                <a href="/search/invest/<?=$rc_data['rc_ticker']?>" class="more"><img src="/img/more_Black.png" alt="더보기"></a>
                                <!-- 수익성(연환산) -->
                                <div>
                                    <table cellspacing="0" border="1" class="tableRanking">
                                        <colgroup>
