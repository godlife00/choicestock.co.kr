            ...
            <div class="serviceStep step01">
				...
				<?php if($this->session->userdata('user_auto_pay') == 'Y') :?>
					<div class="step_box active" id="payment_choice1">                    
						<h3 class="title">월 정기결제 <span class="way">신용카드, 체크카드</span></h3>
						<div class="payRight">
                ...
                <div class="step_box"  id="payment_choice2">                    
                    <h3 class="title">3개월 기간 결제<span class="way">신용카드, 체크카드, 가상계좌(무통장), 계좌이체</span></h3>
                    <div class="payRight">  
                ...
                <div class="step_box"  id="payment_choice3">                    
                    <h3 class="title">6개월 기간 결제<span class="way">신용카드, 체크카드, 가상계좌(무통장), 계좌이체</span></h3>
                    <div class="payRight"> 
