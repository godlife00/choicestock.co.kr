			...
			<div class="main_mid game_area">
				<h3 class="title"><a href="/<?=KW?>_stock/winner">승부주</a> <span class="remark">스탁히어로 알고리즘 종목추천</span></h3>
				<a href="/<?=KW?>_stock/winner" class="more"><img src="/img/more_Black.png" alt="더보기"></a>
				<div class="list_area">
							...
							<div class="swiper-slide">
								<div class="area">
									...
									<?php if($this->session->userdata('is_paid')===TRUE || $win<1) :?>
										<li class="title"><a href="/<?=KW?>_search/summary/<?=$winner['win_ticker']?>"><?=$winner['tkr_name']?></a></li>
									...
									<?php else :?>
										<li class="title"><a href="javascript:<?=($this->session->userdata('is_newlink')===TRUE) ? 'fnSinChungNew();':'fnSinChung();'?>"><?=iconv_substr($winner['tkr_name'], 0, 1, 'utf-8')?><span class="remark"><div class="txt_filter size_M"><i></i><i></i><i></i><i></i></div></span></a></li>
										...
										<li class="num">
											...
											<div>
												<span class="th">목표수익률</span>
												<span class="increase dod prm_lock"><a href="javascript:<?=($this->session->userdata('is_newlink')===TRUE) ? 'fnSinChungNew();':'fnSinChung();'?>"><img src="/img/prm_lock.png" alt="잠김"></a></span>
