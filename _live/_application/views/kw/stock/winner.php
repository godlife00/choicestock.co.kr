                            ...
                            <div class="game_list">
                                ...
                                <div class="list">
                                    <div class="game_event">
                                        ...
                                        <a href="/<?=KW?>_search/summary/<?=$winner['win_ticker']?>"><?=$winner['tkr_name']?>
                                        <?php else :?>
                                        <a href="javascript:<?=($this->session->userdata('is_newlink')===TRUE) ? 'fnSinChungNew();':'fnSinChung();'?>"><?=iconv_substr($winner['tkr_name'], 0, 1, 'utf-8')?><span class="remark"><div class="txt_filter size_M"><i></i><i></i><i></i><i></i></div></span>
                                        <?php endif;?>
                                        </a></div>
                                        <div class="num">
