            ...
            <div class="sub_mid research_board">
                <div class="video_tabs">
                    <a href="/<?=KW?>_stock/note" class="">종목노트</a>                    
                    <a href="/<?=KW?>_stock/research" class="">탐구생활</a>                    
                ...
                <div  id="analysis_list" class="lst_type video_list">
					...
					<?php if($val['vm_display_date'] > date('Y-m-d H:i:s') || $val['vm_view_kw'] !='Y') continue;?>
            ...
            function view_more() {
                ...
                page += 1;
                $.post('/<?=KW?>_stock/ajax_get_vod_list', {'page': page}, function(res) {
                    if($.trim(res).length) {
