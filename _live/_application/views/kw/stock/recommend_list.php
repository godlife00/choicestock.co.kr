 								...
 								<div class="recom_chartList">
                                    <div class="chartData">
                                        <div class="left">
											...
											<a href="javascript:<?=($this->session->userdata('is_newlink')===TRUE) ? 'fnSinChungNew();':'fnSinChung();'?>"><?=iconv_substr($r['ticker']['tkr_name'], 0, 1, 'utf-8')?><span class="remark"><div class="txt_filter size_M"><i></i><i></i><i></i><i></i></div></span>
											<?php else :?>
											<a href="/<?=KW?>_stock/recommend_view/<?=$r['rc_id']?>"><?=$r['ticker']['tkr_name']?>
											<?php endif;?>
                                            ...
                                            <ul class="info">
												...
												<?php else :?>
												<a href="/<?=KW?>_stock/recommend_view/<?=$r['rc_id']?>">
												<?php endif;?>												
