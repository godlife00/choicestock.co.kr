			...
			<form name="catchForm" method="post" action="/<?=X1?>_stock/set_catch">
			...
			<?php if($this->session->userdata('is_paid')===TRUE) :?>
                ...
                <div class="chart_catch">
                    <div class="data_area">
                        <h2 class="title"><a href="/<?=X1?>_search/invest_charm/<?=$ticker['tkr_ticker']?>"><?=$ticker['tkr_name']?></a></h2>
                        <ul class="info">
                        ...
                        <div class="go_page">
                            <a href="<?=str_replace('/stock/recommend_view', '/'.X1.'_stock/recommend_view', $ticker['recom_link'])?>"><span class="quarter recom">추천</span></a>
                            <a href="<?=str_replace('/stock/recommend_view', '/'.X1.'_stock/recommend_view', $ticker['recom_link'])?>" class="more"><img src="/img/more_white.png" alt="더보기"></a>
                        </div>
						<?php endif ; ?>
                        ...
                        <ul class="info_icon">
							...
							<li><a href="/<?=X1?>_stock/recipe/dividend">배당주</a></li>
							<?php endif; ?>
							<?php if($ticker['mri']['m_future_score'] >= 16) : ?>
							<li><a href="/<?=X1?>_stock/recipe/growth">성장주</a></li>
							<?php endif; ?>
							<?php if($ticker['mri']['m_biz_moat_score'] >= 16) : ?>
							<li><a href="/<?=X1?>_stock/recipe/moat">가치주</a></li>
							<?php endif; ?>
					...
					<span class="same_selt"><a href="/<?=X1?>_search/invest_charm/<?=$choice_ticker?>"><?=$choice_name?></a>와(과) 같은 업종입니다</span>
					<?php endif;?>
                </div>
                <!-- //chart_catch -->
				<?php $idx++; endforeach;?>
					<?php if($is_next === true) :?>
					<div class="next"><a href="/<?=X1?>_stock/<?=($is_file===true)? 'add_catch2':'add_catch'?>?mode=auto&idx=<?=$idx?>&page=1" class="nextPage">다음 페이지</a></div>
					<?php endif;?>
				<?php else :?>
			...
			<?php else :?>
				...
				<div class="prm_div weeks_free">
					<div class="box">
						...
						<div class="right">
							<p><a href="javascript:fnLogin();" class="btn_free">첫달 1,000원<i></i></a></p>                                
						</div>
					</div>
				</div>
				<!-- //프리미엄 서비스 부분 -->
				...
				<div class="prm_div weeks_free event_900">
					<div class="box">
						...
						<div class="right">
							<p><a href="javascript:fnLogin();" class="btn_900">첫달 900원<i></i></a></p>
						</div>
					</div>
				</div>
				<!-- //프리미엄 서비스 부분 1주년 이벤트 900원 -->			
