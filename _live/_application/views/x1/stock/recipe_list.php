...
<?php endif;?>
								<?php if($type == 'earnings') :?>
									<?php $in_cnt=0; foreach($list['recent_report'] as $key => $val) : ?>
										...
										<div class="area">
											<ul class="list">
												<li class="title"><a href="/<?=X1?>_search/invest_charm/<?=$val['tkr_ticker']?>"><?=$val['tkr_name']?></a></li>
											...
											<div class="analysis_score">
												...
												<div class="result_score">
													<span class="num"><?=($val['tkr_sf1_currency']=='USD')?number_format($val['sf1_netinc']/1000000):number_format($val['sf1_netinccmnusd']/1000000)?> <span class="hit">백만</span></span>                                
												</div>
												<!-- //실적발표 -->
								...
								<?php else :?>
									...
									<div class="area">
										<ul class="list">
											...
											<?php else :?>
											<li class="title"><a href="/<?=X1?>_search/invest_charm/<?=$val['m_ticker']?>"><?=$val['m_korname']?></a></li>
