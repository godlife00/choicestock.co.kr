                            ...
                            <div class="game_list">
                                ...
                                <div class="list">
                                    <div class="game_event">
										...
										<a href="/<?=X1?>_search/invest_charm/<?=$winner['win_ticker']?>"><?=$winner['tkr_name']?>
										<?php else :?>
										<a href="javascript:fnLogin();"><!--<a href="#" data-modal="modal-3" class="btn_free md-trigger">--><?=iconv_substr($winner['tkr_name'], 0, 1, 'utf-8')?><span class="remark"><div class="txt_filter size_M"><i></i><i></i><i></i><i></i></div></span>
										<?php endif;?>
										</a></div>
                                        <div class="num">
