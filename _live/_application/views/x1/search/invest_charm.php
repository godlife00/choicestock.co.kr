...
<?php if($sec_ticker=='' && $pri_ticker=='') {?>
				...
				<?php if($fairvalue_rate >= -5) :?>
					...
					<div class="value_chart">
						<div class="chart_analysis">
							...
							<div class="arrow_box btm" style="left: <?=$fairvalue_rate?>%;">
								...
								php else :*/?>
								<strong><?=$this->common->set_pricepoint(number_format($ticker['tkr_close'], 2), '1');?></strong>
								<?php //endif;?>
							</div>
							...
							<div class="line">
								...
								<ul class="evaluation">
									...
									<li>
										...
										<?php if(isset($pre_fairvalue) && $pre_fairvalue > 0) :?>
										<!--<div class="pre_d"><span>(<?=date('m/d', strtotime($pre_sepdate));?>)</span> <?=$this->common->set_pricepoint($pre_fairvalue, '1');?></div>-->
										<?php endif;?>
									</li>
									<li>고평가</li>
									<li>매우<br>고평가</li>
					...
					<!-- 1주년 900원 이벤트 -->
					<div class="event_900won">
						<a href="javascript:fnLogin();" class="btn_free"><img src="/img/banner/event_900won.png" alt="초이스스탁US 프리미엄 이벤트 첫달 900원"></a>
					</div>
					<!-- //event_900won -->
					<!-- //1주년 900원 이벤트 -->
					<?php else :?>
					...
					<div class="prm_value_chart">
						<a href="javascript:fnLogin();" class="btn_free"><!--<a href="#" data-modal="modal-3" class="btn_free md-trigger">--><img src="/img/prm_value_chart.png" alt="초이스스탁US 프리미엄 이벤트 첫달 1,000원"></a>                    
					</div>
					<?php endif;?>
					...
					<div class="evaluation_data">
						...
						<div class="guide_box">
							<span class="clse">닫기</span>                                    
							<ul>
								<li>적정주가는 기업의 과거 실적과 이익 성장 유지 가능성 및 향후 전망을 반영해 계산합니다. 종목진단 점수가 우량 기업 이상이고, 현재가가 저평가 상태에 있는 기업에 투자하는 것이 좋습니다.<br>
									<br>
									적극 매수 : 현재가 &#60; 매우 저평가<br>
				...
				<?php else :?>
					...
					<?php if($is_event === true) :?>
						<a href="javascript:fnLogin();" class="btn_free"><img src="/img/banner/event_900won.png" alt="초이스스탁US 프리미엄 이벤트 첫달 900원"></a>                    
					<?php else :?>
						<a href="javascript:fnLogin();" class="btn_free"><img src="/img/prm_value_chart.png" alt="초이스스탁US 프리미엄 이벤트 첫달 1,000원"></a>                    
					<?php endif;?>
                ...
                <div class="investCharm_area">
                    ...
                    <div class="tab_diagnosis_area">
						...
						<script>SubRecomSpiderChart('charm_top_spider_chart', [<?=$mri_data['m_future_stars']?>, <?=$mri_data['m_biz_moat_stars']?>, <?=$mri_data['m_biz_cashflow_stars']?>, <?=$mri_data['m_biz_growth_stars']?>, <?=$mri_data['m_biz_safety_stars']?>])</script>

                        <span class="charm_num">
                            <strong><?=$mri_data['m_biz_total_score']?></strong> / 100
                            <span class="total">종목진단 종합점수</span>
                        </span>
                        <!-- //charm_num -->
                        ...
                        <table cellspacing="0" border="1" class="tableRanking table_alloca">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="num">
										<?php if($part_page!='et') :?><a href="/<?=X1?>_attractiveness/attractive?sort=future&netincome=all&marketcap=over100billion"><?php endif;?><span>상위 <?=$future_rank_rate?>%</span><?php if($part_page!='et') :?></a><?php endif;?>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="title">
                                    ...
                                    <td class="num">
										<?php if($part_page!='et') :?><a href="/<?=X1?>_attractiveness/attractive?sort=moat&netincome=all&marketcap=over100billion"><?php endif;?><span>상위 <?=$moat_rank_rate?>%</span><?php if($part_page!='et') :?></a><?php endif;?>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="title">
                                    ...
                                    <td class="num">
                                <?php if($part_page!='et') :?><a href="/<?=X1?>_attractiveness/attractive?sort=safety&netincome=all&marketcap=over100billion"><?php endif;?><span>상위 <?=$safety_rank_rate?>%</span><?php if($part_page!='et') :?></a><?php endif;?>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="title">
                                    ...
                                    <td class="num">
										<?php if($part_page!='et') :?><a href="/<?=X1?>_attractiveness/attractive?sort=growth&netincome=all&marketcap=over100billion"><?php endif;?><span>상위 <?=$growth_rank_rate?>%</span><?php if($part_page!='et') :?></a><?php endif;?>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="title">
                                    ...
                                    <td class="num">
										<?php if($part_page!='et') :?><a href="/<?=X1?>_attractiveness/attractive?sort=cashflow&netincome=all&marketcap=over100billion"><?php endif;?><span>상위 <?=$cashflow_rank_rate?>%</span><?php if($part_page!='et') :?></a><?php endif;?>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
						...
						<div class="hiding_box">
							...
							<?php include_once X1_INC_PATH.'/premium_banner.php'; ?>
							<?php endif;?>
									...
									<div class="swiper-slide">
										<div class="chart_area">
											<div class="chartData">
												...
												<span class="chart_name"><?php if($part_page == ''){?><a href="/<?=X1?>_search/invest_charm/<?=$row['m_ticker'];?>?pn=<?=$part_name;?>&pg=<?=$part_page;?>"><?php }?><?=$row['m_korname']?> (<?=$row['m_ticker']?>)<?php if($part_page == ''){?></a><?php }?></span>
												...
												<div class="chart_star">
													...
													<!-- //star_area -->
													<?php if($part_page == ''){?><a href="/<?=X1?>_search/invest_charm/<?=$row['m_ticker']?>?pn=<?=$part_name;?>&pg=<?=$part_page;?>" class="more">자세히 <i>>></i> </a><?php }?>
												</div>
												<!-- //chart_star -->
											</div>
										</div>
						...
						<a href="/<?=X1?>_main/service_guide" class="compet_chart_uses">
...
<?php }else{?>
		...
		<div class="sub_mid nondata">
			<p class="nodata_guide"><strong><?=$sec_ticker;?></strong>의 상세 기업정보는 <strong><?php if($part_page == ''){?><a href="/<?=X1?>_search/invest_charm/<?=$pri_ticker?>?pn=<?=$part_name;?>&pg=<?=$part_page;?>"><?php }?><?=$pri_ticker?><?php if($part_page == ''){?></a><?php }?></strong> 종목에서 확인할 수 있습니다.</p>
		</div>
		<!-- //sub_mid nondata -->
<?php }?>
