                ...
                <div class="investCharm_area">
                    ...
                    <div class="tab_diagnosis_area">
                        ...
                        <table cellspacing="0" border="1" class="tableRanking table_alloca">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="num">
                                        <?php if($part_page!='et') :?><a href="/<?=EG?>_attractiveness/attractive?sort=dividend&netincome=all&marketcap=over100billion"><?php endif;?><span>상위 <?=$dividend_rank_rate?>%</span><?php if($part_page!='et') :?></a><?php endif;?>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="title">
                                    ...
                                    <td class="num">
                                        <?php if($part_page!='et') :?><a href="/<?=EG?>_attractiveness/attractive?sort=moat&netincome=all&marketcap=over100billion"><?php endif;?><span>상위 <?=$moat_rank_rate?>%</span><?php if($part_page!='et') :?></a><?php endif;?>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="title">
                                    ...
                                    <td class="num">
                                <?php if($part_page!='et') :?><a href="/<?=EG?>_attractiveness/attractive?sort=safety&netincome=all&marketcap=over100billion"><?php endif;?><span>상위 <?=$safety_rank_rate?>%</span><?php if($part_page!='et') :?></a><?php endif;?>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="title">
                                    ...
                                    <td class="num">
                                        <?php if($part_page!='et') :?><a href="/<?=EG?>_attractiveness/attractive?sort=growth&netincome=all&marketcap=over100billion"><?php endif;?><span>상위 <?=$growth_rank_rate?>%</span><?php if($part_page!='et') :?></a><?php endif;?>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="title">
                                    ...
                                    <td class="num">
                                        <?php if($part_page!='et') :?><a href="/<?=EG?>_attractiveness/attractive?sort=cashflow&netincome=all&marketcap=over100billion"><?php endif;?><span>상위 <?=$cashflow_rank_rate?>%</span><?php if($part_page!='et') :?></a><?php endif;?>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="hiding_box">
                            ...
                            <?php //include_once EG_INC_PATH.'/premium_banner.php'; ?>
                            <?php endif;?>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="chart_area">
                                            <div class="chartData">
                                                ...
                                                <span class="chart_name"><?php if($part_page == ''){?><a href="/<?=EG?>_search/invest_charm/<?=$row['m_ticker'];?>?pn=<?=$part_name;?>&pg=<?=$part_page;?>"><?php }?><?=$row['m_korname']?> (<?=$row['m_ticker']?>)<?php if($part_page == ''){?></a><?php }?></span>
                                                ...
                                                <div class="chart_star">
                                                    ...
                                                    <!-- //star_area -->
                                                    <?php if($part_page == ''){?><a href="/<?=EG?>_search/invest_charm/<?=$row['m_ticker']?>?pn=<?=$part_name;?>&pg=<?=$part_page;?>'" class="more">자세히 <i>>></i> </a><?php }?>
                                                </div>
                                                <!-- //chart_star -->
                                            </div>
                                        </div>
                        ...
                        <!-- //compet_chart -->
                            ...
                            <!--<a href="/<?=EG?>_main/service_guide" class="compet_chart_uses">
...
<?php }else{?>
        ...
        <div class="sub_mid nondata">
            <p class="nodata_guide"><strong><?=$sec_ticker;?></strong>의 상세 기업정보는 <strong><?php if($part_page == ''){?><a href="/<?=EG?>_search/invest_charm/<?=$pri_ticker?>?pn=<?=$part_name;?>&pg=<?=$part_page;?>"><?php }?><?=$pri_ticker?><?php if($part_page == ''){?></a><?php }?></strong> 종목에서 확인할 수 있습니다.</p>
        </div>
        <!-- //sub_mid nondata -->
<?php }?>
