                                <?php if($type == 'earnings') :?>
                                    <?php foreach($list['recent_report'] as $key => $val) : ?>
                                        ...
                                        <div class="area">
                                            <ul class="list">
                                                <li class="title"><a href="/<?=KW?>_search/invest_charm/<?=$val['tkr_ticker']?>"><?=$val['tkr_name']?></a></li>
                                ...
                                <?php else :?>
                                    ...
                                    <div class="area">
                                        <ul class="list">
                                            <li class="title"><a href="/<?=KW?>_search/invest_charm/<?=$val['m_ticker']?>"><?=$val['m_korname']?></a></li>
