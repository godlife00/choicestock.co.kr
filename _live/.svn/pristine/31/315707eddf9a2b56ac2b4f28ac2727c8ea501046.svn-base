    ...
    $.ajax({
        ...
        success : function(data) {
            if(data.success) {
                ...
                location.href='/mr_stock/catch_info?catch_list='+data.catch_list+'&sector_list='+data.sector_list;
            }
            else {
                alert(data.msg);
                location.href='/mr_stock/catch_info';
            }
        }
    });
}
...
function fnCatchNewSave() {
	...
	$('#loading').css("display", "block");
	location.href='/mr_stock/catch_process?catchType='+catchType+'&catchSize='+catchSize+'&catchSector='+catchSec;
}
...
function fnMyTickerSave() {
    ...
    location.href= '/mr_main/saveTicker?ticker='+ticker;
}
...
function fnMyitem(ticker, page, count, id) {
    ...
    var href = '/mr_search/setTicker/'+ticker+'/'+count;
...
function moveToSearch(div) {
    ...
    if ($('li a._on', div).length > 0) {
        ...
        location.href = '/mr_search/summary/' + keyword;
    } else {
...
function onSearchTicker(ticker) {
    ...
    location.href = '/mr_search/summary/' + ticker;
}
...
function setSearchHistory(keyword) {
    ...
    */
    ...
    $.ajax({
        url: '/mr_main/ajax_save_search_history',
        type: 'GET',
        data: { 'ticker': keyword },
        async: false,
        success: function () {
