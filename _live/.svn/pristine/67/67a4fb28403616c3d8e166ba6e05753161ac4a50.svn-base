...
<?php endif;?>
								<?php if($type == 'earnings') :?>
                                    <?php $in_cnt=0; foreach($list['recent_report'] as $key => $val) : ?>
										<div class="area">
											<ul class="list">
												<li class="title"><a href="/<?=KW?>_search/summary/<?=$val['tkr_ticker']?>"><?=$val['tkr_name']?></a></li>
												<li class="num">
								...
								<?php elseif($type == 'interest') :?>
									...
									<div class="area">
										<ul class="list">
											<li class="title">
												<a href="/<?=KW?>_search/summary/<?=$val['m_ticker']?>"><?=$val['ticker']['tkr_name']?></a>
									...
									<div class="area">
										<ul class="list">
											...
											<?php if($this->session->userdata('is_paid')===TRUE) :?>
												<a href="/<?=KW?>_search/summary/<?=$val['tkr_ticker']?>"><?=$val['tkr_name']?></a>
												<span class="sum"><?=$val['tkr_ticker']?></span>
											<?php else :?>										
												<a href="javascript:<?=($this->session->userdata('is_newlink')===TRUE) ? 'fnSinChungNew();':'fnSinChung();'?>"><?=iconv_substr($val['tkr_name'], 0, 1, 'utf-8')?><span class="remark"><div class="txt_filter size_M"><i></i><i></i><i></i><i></i></div></span></a>
												<span class="sum">
                                ...
                                <?php else :?>
									...
									<div class="area">
										<ul class="list">
											...
											<?php else :?>										
												<li class="title"><a href="/<?=KW?>_search/summary/<?=$val['m_ticker']?>"><?=$val['m_korname']?></a></li>
											<?php endif;?>
											<li class="num">
												<span><?=$price?><b>%</b></span>
											</li>
