...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/globalstock_pre.css?v=<?=filemtime(APP_PATH.'/css/globalstock_pre.css')?>" />
    <!-- js -->
    <script src="/js/globalstock_pre.js?v=<?=filemtime(APP_PATH.'/js/globalstock_pre.js')?>"></script>
	...
	<div id="wrap">
        ...
        <div id="header" class="header" style="display: block; height: 40px;">
            <div class="headerTop">
                ...
                <div class="hm">
                    <a href="/<?=PX?>_main/search" class="go_sch"><img src="/img/icon_search.svg" alt="검색하기"></a>
                </div>
                <!-- //hm -->
            </div>
            <!-- //headerTop -->
