            ...
            <form name="catchForm" method="post" action="/<?=WT?>_stock/set_catch">
            ...
            <div class="catch_wrap">
                ...
                <a href="#catch_cncl" class="terms_btn btn_payCan show_pop03" onClick='javascript:fnSetCatch();'>추천종목</a></p>
            ...
            <?php if($this->session->userdata('is_paid')===TRUE) :?>
                ...
                <div class="chart_catch">
                    <div class="data_area">
                        <h2 class="title"><a href="/<?=WT?>_search/summary/<?=$ticker['tkr_ticker']?>"><?=$ticker['tkr_name']?></a></h2>
                        <ul class="info">
                        ...
                        <ul class="detail">
							...
							<li class="per">
								<span class="<?=$wval['diff_rate'] > 0 ? 'increase' : 'decrease'?>"><?=($wval['diff_rate']>0) ? '+ ':''?><?=$wval['diff_price']?> <span>(<?=($wval['diff_rate']>0) ? '+':''?><?=$this->common->set_pricepoint($wval['diff_rate'], '2')?><b>%</b>)</span></span>
							</li>
							<li class="day"><?=($wval['status'] == '0') ? date('y.m/d H:i', strtotime($wval['updated_at'])) : date('y.m/d', strtotime($wval['updated_at']))?>, USD</li>
							<?php else :?>							
                            <li class="num">
                        ...
                        <div class="go_page">
                            <a href="<?=str_replace('/stock/recommend_view', '/'.WT.'_stock/recommend_view', $ticker['recom_link'])?>"><span class="quarter recom">추천</span></a>
                            <a href="<?=str_replace('/stock/recommend_view', '/'.WT.'_stock/recommend_view', $ticker['recom_link'])?>" class="more"><img src="/img/more_white.png" alt="더보기"></a>
                        </div>
                        <?php endif ; ?>
                        ...
                        <div class="area">
                            ...
                            <div class="analysis_score">
                                <span class="score"><strong><?=$ticker['mri']['m_biz_total_score']?></strong> P</span>
                        ...
                        <ul class="info_icon">
                            ...
                            <li><a href="/<?=WT?>_stock/recipe/dividend">배당주</a></li>
                            <?php endif; ?>
                            <?php if($ticker['mri']['m_future_score'] >= 16) : ?>
                            <li><a href="/<?=WT?>_stock/recipe/growth">성장주</a></li>
                            <?php endif; ?>
                            <?php if($ticker['mri']['m_biz_moat_score'] >= 16) : ?>
                            <li><a href="/<?=WT?>_stock/recipe/moat">가치주</a></li>
                            <?php endif; ?>
                    ...
                    <span class="same_selt"><a href="/<?=WT?>_search/summary/<?=$choice_ticker?>"><?=$choice_name?></a>와(과) 같은 업종입니다</span>
                    <?php endif;?>
                </div>
                <!-- //chart_catch -->
                <?php $idx++; endforeach;?>
                    <?php if($is_next === true) :?>
                    <div class="next"><a href="/<?=WT?>_stock/<?=($is_file===true)? 'add_catch2':'add_catch'?>?mode=auto&idx=<?=$idx?>&page=1" class="nextPage">다음 페이지</a></div>
                    <?php endif;?>
                <?php else :?>
            ...
            <?php else :?>
                ...
                <div class="prm_div weeks_free">
                    <div class="box">
                        <div class="left">
                            <p class="title"><i></i>미국주식창 프리미엄</p>
                            <p class="txt">모든 서비스를 제한없이 이용하실 수 있습니다.</p>
                        </div>
                        <div class="right">
                            <p><a href="#" data-modal="modal-3" class="btn_free md-trigger">첫 달 3,300원<i></i></a></p>              
                        </div>
                    </div>
                </div>
                <!-- //프리미엄 서비스 부분 -->
        ...
        <div id="catch_cncl" class="setting_area">
            ...
            <div class="pop_con">
                ...
                <div class="btnArea payBtn">
                    <a href="javascript:;" class="btn btn_cncl"><i></i>이전</a>
                    <a href="javascript:;" class="btn btn_save terms_btn btn_payCan show_pop04" onClick="javascript:fnNextStep('1');">다음<i></i></a>
                </div>
    ...
    <div class="setting_pop catch_edt catch_edt_02">
        ...
        <div id="catch_cncl" class="setting_area">
            ...
            <div class="pop_con">
                ...
                <div class="btnArea payBtn">
                    <a href="javascript:;" class="btn btn_cncl show_pop03" onClick="javascript:fnPreStep('1');"><i></i>이전</a>
                    <a href="javascript:;" class="btn btn_save terms_btn btn_payCan show_pop05" onClick="javascript:fnNextStep('2');">다음<i></i></a>
                </div>
    ...
    <div class="setting_pop catch_edt catch_edt_03">
        ...
        <div id="catch_cncl" class="setting_area">
            ...
            <div class="pop_con">
                ...
                <div class="btnArea payBtn">
                    <a href="javascript:;" class="btn btn_cncl show_pop04" onClick="javascript:fnPreStep('2');"><i></i>이전</a>
                    <a href="javascript:;" class="btn btn_save terms_btn btn_payCan show_pop05_2" onClick="javascript:fnNextStep('3');">다음<i></i></a>
                </div>
    ...
    <div class="setting_pop catch_edt catch_edt_03_2">
        ...
        <div id="catch_cncl" class="setting_area">
            ...
            <div class="pop_con">
                ...
                <div class="btnArea payBtn">
                    <a href="javascript:;" class="btn btn_cncl show_pop05" onClick="javascript:fnPreStep('3');"><i></i>이전</a>
                    <a href="javascript:;" class="btn btn_save terms_btn btn_payCan show_pop05_3" onClick="javascript:fnNextStep('4');">다음<i></i></a>
                </div>
    ...
    <div class="setting_pop catch_edt catch_edt_03_3">
        ...
        <div id="catch_cncl" class="setting_area">
            ...
            <div class="pop_con">
                ...
                <div class="btnArea payBtn">
                    <a href="javascript:;" class="btn btn_cncl show_pop05_2" onClick="javascript:fnPreStep('4');"><i></i>이전</a>
                    <a href="javascript:;" class="btn btn_save terms_btn btn_payCan" onClick="javascript:fnCatchNewSave();">확인<i></i></a>
                </div>
