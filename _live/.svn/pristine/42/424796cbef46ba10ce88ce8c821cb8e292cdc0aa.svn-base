...
class X1_attractiveness extends X1_BaseMobile_Controller {
    ...
    public function index() {
        $this->common->locationhref('/'.X1.'_attractiveness/attractive');
    ...
    public function attractive() {
        ...
        $data['content_html'] = $this->load->view('/'.X1.'/attractiveness/attractive_list.php', array('list' => $result['list']), true);
    ...
    public function ajax_get_attractive_list() {
        ...
        $result = $this->_get_attractive_data();
        $content_html = $this->load->view('/'.X1.'/attractiveness/attractive_list.php', array('list' => $result['list']), true);
        echo $content_html;
        return;
    }
    ...
    private function _get_attractive_data() {
        ...
        switch($sort) {
            case 'total': // 종합
                ...
                break;
            case 'future': // 미래성장성
                $add_extra['order_by'] = 'm_future_score desc, m_biz_total_score desc';
                break;
            case 'moat': // 사업 독점력
