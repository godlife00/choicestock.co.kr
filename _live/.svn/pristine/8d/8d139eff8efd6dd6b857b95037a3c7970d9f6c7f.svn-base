            <?php include_once EG_INC_PATH.'/ticker_submenu.php'; ?>
            ...
            <div class="sub_mid bandchart_more">
                <p><i></i>종목추천&포트폴리오 운영안내 <a href="/<?=EG?>_stock/recommend/portfolio#more" class="more">자세히</a></p>                
            </div>
            ...
            <div class="sub_mid eventPicks_area">
                ...
                <?php if($tab == '1') : ?>
                    ...
                    <!--mjm <div class="banner_prm">
                        <span class="cho_prm"><i></i>초이스스탁US 프리미엄</span>
                        <a href="/<?=EG?>_main/service_free" class="weeks_free">[첫달 3,000원!]</a>
                    </div>-->
                    <?php endif;?>
                    <?php endif;?>
                <?php endif;?>
                                ...
                                <table cellspacing="0" border="1" class="tableRanking sum_table">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <?php else :?>
                                            <a href="/<?=EG?>_stock/recommend_view/<?=$val['rc_id']?>"><?=$val['tkr_name']?><span class="ticker"><?=$val['rc_ticker']?></span></a></td>
                                            <?php endif;?>
                                            <td class="num">
                ...
                function view_more() {
                    ...
                    page += 1;
                    $.post('/<?=EG?>_stock/ajax_get_recommend_list', {'page': page}, function(res) {
                        if($.trim(res).length) {
                ...
                $(function() {
                    $('.sub_top .chart_area').on('click', function() {
                        location.href = '/<?=EG?>_stock/recommend_view/' + $(this).data('id');
                    });
                });
                </script>
                <?php endif;?>
