...
<?php if($this->session->userdata('is_paid')===FALSE && $open_ticker===FALSE) :?>
                <div class="prm_div weeks_free">
                    <div class="box">
                        ...
                        <div class="right">
                            <p>
                                <a href="/<?=WT?>_main/service" class="btn_free md-trigger">미국주식창 신청하기<i></i></a>
                            </p>
                            <p><a href="/<?=WT?>_main/service" class="go_link">[서비스 안내]</a></p>
                        </div>
                    </div>
                </div>
<?php else :?>
...
<?php if($sec_ticker=='' && $pri_ticker=='') {?>
			<?php if($fairvalue_rate >= -5) :?>
                <div class="adequate_stock">
                    <div class="box">
                        <p class="title"><a href="javascript:;">적정주가</a></p>
                        <div class="con">
			...
			<?php endif;?>
                <div class="bandchart_more">
                    <p><i></i>‘적정주가 밴드차트’는 적정주가 추세를 시계열로 제공하여, 매매전략을 세우는데 도움을 드리는 서비스입니다.</p>
				...
				<div class="bandchart_sume" id="more">
                    <p class="txt"><i></i>‘적정주가 밴드차트’는 적정주가 추세를 시계열로 제공하여, 매매전략을 세우는데 도움을 드리는 서비스입니다. </p>
                    <p class="txt">‘적정주가(intrinsic value)’란 기업의 미래 창출 이익 또는 현금 흐름을 현재 기준으로 평가한 가격입니다.</p>

                    <div class="box">
                        <p class="title">미국주식창의 적정주가 밴드차트는</p>
                        <ul>
                            ...
                            <li><i>4.</i>투자매력 포인트가 낮은 기업은 리스크가 발생시 주가 급락 가능성이 높아, 투자자 보호를 위해 적정주가를 제공하지 않습니다.</li>
                    ...
                    <p class="guide">미국주식창에서 제공하는 투자매력 포인트가 우량 기업이고, 저평가 상태에 있는 종목에 투자하는 것이 좋습니다.</p>                    
					<a href="https://youtu.be/rGb3ZmSbcFc" class="youtube_link"><i></i>매매 타이밍을 쉽게 잡을 수 있는 적정주가 매매전략</a>
                </div>
                <!-- //bandchart_sume -->
            </div>
            <!-- //sub_mid -->
