            ...
            <div class="sub_mid latest_results">
                <div class="tabsArea">
                    <ul class="tabs tabs_two">
                        <li class="active" rel="tab1"><a href='/<?=X1?>_main/search'>관심종목</a></li>
                        <li rel="tab2">인기종목</li>
                    </ul>
                    ...
                    <div class="tab_container">
                        ...
                        <div id="tab1" class="tab_content">
                            ...
                            <div class="onestep_guide">
                                ...
                                <a href="/<?=X1?>_main/search" class="more"><span>관심종목</span><img src="/img/more_white.png" alt="더보기"></a>
...
<?php //iconv_substr($val['ticker']['tkr_name'], 0, 1, 'utf-8')?>
                                        ...
                                        <script>
                                            var value = [{
                                                data: [
                                                    ...
                                                    <?php $careful .= '<li><a href="/'.X1.'_search/invest_charm/'.$val['ticker']['tkr_ticker'].'">'.$ticker_name.'</a></li>'."\n"?>
                                                    <?php $is_careful = TRUE?>
                                                    <?php endif;?>
                                                    <?php if($val['m_biz_total_score']>=65 && $val['ticker']['tkr_close'] < $val['m_v_fairvalue2']) :?>
                                                    <?php if($is_careful === FALSE):?>
                                                    <?php $hopeful .= '<li><a href="/'.X1.'_search/invest_charm/'.$val['ticker']['tkr_ticker'].'">'.$ticker_name.'</a></li>'."\n"?>
                                                    <?php endif;?>
                                                    <?php endif;?>
                                                    <?php endforeach;?>
                                                ]
                                ...
                                <div class="dgtic_results">
                                    ...
                                    <!-- //caution -->
									<p class="nodata_guide tr_left">* 투자 유망/유의 종목은 종목진단 점수, 밸류에이션, 재무 안전성 등을 반영한 포트폴리오 진단 알고리즘으로 평가합니다. </p>
                                </div>
                                <!-- //dgtic_results -->
                            </div>
                            <!-- //onestep_chart -->
                            ...
                            <table cellspacing="0" border="0" class="tableRanking type_2Line">
                                ...
                                ?>
                                    <tr>
                                        <td class="title"><a href="/<?=X1?>_search/invest_charm/<?=$val['ticker']['tkr_ticker']?>"><?=$val['ticker']['tkr_name']?><span class="ticker"><?=$val['ticker']['tkr_ticker']?></span></a></td>
                                        <td class="num">
                            ...
                            <div class="onestep_sample">
                                <a href="javascript:fnLogin();" class="sample_box md-trigger"><!--<a href="#" data-modal="modal-3" class="sample_box md-trigger">-->
                            ...
                            <!--<div class="no_data">
                                <p>관심종목의 종목진단 점수와<br>밸류에이션을 쉽게 확인할 수 있습니다.<br><br>
                            ...
                            <div class="one_step">
                                <span class="txt">초이스스탁에서 추천하는 취향저격 종목을 확인하세요</span>
                                <a href="/<?=X1?>_stock/catch_info" class="more"><span>종목 캐치</span><img src="/img/more_yel.png" alt="더보기"></a>
                            </div>
                        </div>
                        ...
                        <div id="tab2" class="tab_content">
                            <div class="">
                                <div class="txt_box">
                                    <p class="txt">투자자가 가장 많이 매매하고 있는 인기종목의 종목진단점수 및 적정주가를 제공합니다.</p>
                                </div>
                                <!-- //txt_box -->
                            </div>
                            ...
                            <table cellspacing="0" border="0" class="tableRanking type_2Line">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <?php else :?>
                                        <td class="prm_lock">
                                            <span><a href="/<?=X1?>_main/service_prm"><img src="/img/prm_lock_mint.png" alt="잠김"></a></span>
                                        </td>
                                        <?php endif;?>
                                    </tr>
                                <?php endforeach; ?>
