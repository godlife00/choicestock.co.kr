            <div class="view_con">
                <div class="top">
                    ...
                    <a href="/<?=X1?>_stock/research" class="go_list">목록보기</a>
                </div>
                <div class="mid">
            ...
            <div class="popularity">
                ...
                <ul class="lst_type">
                    ...
                    <li>
                        <dl class="lst_type2">
                            <dt class="tit"><a href="/<?=X1?>_stock/research_view/<?=$exp['e_id']?>"><strong><?=nl2br($exp['e_title'])?></strong></a></dt>
                            <?php if(strlen($exp['e_thumbnail']) > 0) : ?>
                            <dd class="photo"><a href="/<?=X1?>_stock/research_view/<?=$exp['e_id']?>"><img src="https://hero.datahero.co.kr<?=$exp['e_thumbnail']?>" alt=""></a></dd>
                            <?php endif; ?>
                        </dl>
                    </li>
                    <?php endforeach; ?>
