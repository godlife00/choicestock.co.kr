            ...
            <div class="main_top recommend_area">
                ...
                <a href="/stock/recommend" class="more"><img src="/img/more_Black.png" alt="더보기"></a>
                ...
                ?>
                    <div class="chart_area">
                        <div class="chartData">
                            ...
                            <a href="#" data-modal="<?=($is_event === true) ? 'modal-4':'modal-3'?>" class="btn_free md-trigger"><?=iconv_substr($val['ticker']['tkr_name'], 0, 1, 'utf-8')?><span class="remark"><div class="txt_filter size_B"><i></i><i></i><i></i><i></i></div></span>
                            <?php else :?>
                            <a href="/stock/recommend_view/<?=$val['rc_id']?>"><?=$val['ticker']['tkr_name']?>
                            <?php endif;?>
                            </a></h4>
                            <ul class="info">
                        ...
                        <div class="chartGoal">
                            <dl>
                                ...
                                <?php else :?>
                                <dd class="prm_lock"><a href="#" data-modal="<?=($is_event === true) ? 'modal-4':'modal-3'?>" class="btn_free md-trigger"><img src="/img/prm_lockB.png" alt="잠김"></a></dd>
                                <?php endif;?>
                            </dl>
                            <dl>
                                <dt>수익률</dt>
                ...
                <div class="main_mid game_area">
                    <h3 class="title"><a href="/stock/winner">승부주</a> <span class="remark">- 스탁히어로 알고리즘 종목추천</span></h3>
                    <a href="/stock/winner" class="more"><img src="/img/more_Black.png" alt="더보기"></a>
                        ...
                        <table cellspacing="0" border="0" class="tableRanking type_2Line">
                            ...
                            <?php $win=0; foreach($winner_list as $winner) :?>
                                ...
                                <tr>
                                    ...
                                    <a href="/search/invest_charm/<?=$winner['win_ticker']?>"><?=$winner['tkr_name']?><span class="ticker"><?=$winner['win_ticker']?>
                                    <?php else :?>
                                    <a href="#" data-modal="<?=($is_event === true) ? 'modal-4':'modal-3'?>" class="btn_free md-trigger"><?=iconv_substr($winner['tkr_name'], 0, 1, 'utf-8')?><span class="remark"><div class="txt_filter size_M"><i></i><i></i><i></i><i></i></div></span><span class="ticker"><span class="remark"><div class="txt_filter size_S"><i></i><i></i><i></i><i></i></div></span></span>
                                    <?php endif;?>
                                    </span></a>
                                    </td>
                                    <td class="num">
                                    ...
                                    <?php else :?>
                                    <td class="prm_lock"><span><a href="#" data-modal="<?=($is_event === true) ? 'modal-4':'modal-3'?>" class="btn_free md-trigger"><img src="/img/prm_lock.png" alt="잠김"></a></span></td>
                                    <?php endif;?>
                ...
                <div class="middle_banner event main_event">
                    <a href="/member/login" class="link_banner"><img src="/img/banner_20200611.png" alt="로그인만해도 3일 무료 체험!"></a>
                </div>
                <!-- //middle_banner -->
                <?php endif;?>
               ...
               <?php //if(is_array($recommend) && sizeof($recommend) > 0) : ?>
                ...
                <div class="swiper-container attentionSwiper">
                    ...
                    ?>
                            ...
                            <?php endif;?>
                                        <tr>
                                            <td class="title"><a href="/search/invest_charm/<?=$val['ticker']['tkr_ticker']?>"><?=$val['ticker']['tkr_name']?><span class="ticker"><?=$val['ticker']['tkr_ticker']?></span></a>
                                            </td>
                                            <td class="num">
                ...
                <div class="main_top recommend_area">
					...
					<div class="ptfo_datatable">
						...
						<?php if($this->session->userdata('is_paid')===FALSE) :?>
							...
							<?php if(!strstr($_SERVER['HTTP_USER_AGENT'], 'choicestock')) :?>
							<!-- 구글 에드센스 추천포트폴리오 하단 -->
							<div style="margin:15px 0 0; text-align: center;"><!--padding: 10px 15px; background: #E6E7F4;-->
								<!-- 디스플레이(사각) -->
								<ins class="adsbygoogle"
									style="display:block"
									data-ad-client="ca-pub-6864430327621783"
            ...
            <div class="main_mid catch_area">
                <div class="bg_box">
                    <h3 class="title"><a href="/stock/catch_info">종목캐치</a></h3>
                    <p class="txt">나의 취향에 맞는 종목</p>
                    <a href="/stock/catch_info" class="more"><img src="/img/more_white.png" alt="더보기"></a>
                </div>
                <!-- //bg_box -->
                ...
                <div class="list_area d01">
                    <div class="swiper-container catchSwiper">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <ul class="list">
                                    <li class="title"><a href="/search/invest_charm/<?=$val['ticker']['tkr_ticker']?>"><?=$val['ticker']['tkr_name']?><span class="ticker"><?=$val['ticker']['tkr_ticker']?></span></a></li>
                                    <li class="num">
                                        <span><?=$this->common->set_pricepoint($val['ticker']['tkr_close'], '1')?></span>
                                        <span class="<?=$class?>"><?=$this->common->set_pricepoint($val['ticker']['tkr_rate_str'], '2')?></span>
                                    </li>
                ...
                <div class="prm_div weeks_free">
                    <div class="box">
                        ...
                        <div class="right">
                            <p><a href="/stock/catch_info" class="btn_free">추천종목 확인<i></i></a></p>
                        </div>
                    </div>
                </div>
                <?php endif;?>
			...
			*/
            ...
            <div class="main_mid event_recipe">
                <h3 class="title"><a href="/stock/recipe_intro">투자레시피</a></h3>
                        ...
                        <div id="tab1" class="tab_content">
                            <div class="tableth_box">
                                ...
                                <table cellspacing="0" border="0" class="tableRanking type_2Line">
									...
									<?php if($rc>4) break;?>
                                        <tr>
                                            <td class="title t_short"><a href="/search/invest_charm/<?=$val['tkr_ticker']?>"><?=$val['tkr_name']?><span class="ticker"><?=$val['tkr_ticker']?></span></a></td>
                                            <td class="num">
                            ...
                            <div class="tableth_box">
                                ...
                                <table cellspacing="0" border="0" class="tableRanking type_2Line">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="title"><a href="/search/invest_charm/<?=$row['m_ticker']?>"><?=$row['m_korname']?><span class="ticker"><?=$row['m_ticker']?></span></a>
                                            </td>
                                            <td class="num">
