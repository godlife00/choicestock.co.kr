...
<?php if($sec_ticker=='' && $pri_ticker=='') {?>
				...
				<?php if($fairvalue_rate >= -5) :?>
					...
					<div class="event_900won">
						<a href="#" data-modal="modal-4" class="btn_free md-trigger"><img src="/img/banner/event_900won.png" alt="초이스스탁US 프리미엄 이벤트 첫달 900원"></a>
					</div>
					<!-- //event_900won -->
					<!-- //1주년 900원 이벤트 -->
					<?php else :?>
					<div class="prm_value_chart">
						<a href="#" data-modal="modal-3" class="btn_free md-trigger"><img src="/img/prm_value_chart.png" alt="초이스스탁US 프리미엄 이벤트 첫달 3,000원"></a>                    
					</div>					
					<?php endif;?>
                ...
                <div class="investCharm_area">
                    ...
                    <div class="tab_diagnosis_area">
									...
									<div class="swiper-slide">
										<div class="chart_area">
											<div class="chartData">
												...
												<span class="chart_name"><?php if($part_page == ''){?><a href="/search/invest_charm/<?=$row['m_ticker'];?>?pn=<?=$part_name;?>&pg=<?=$part_page;?>"><?php }?><?=$row['m_korname']?> (<?=$row['m_ticker']?>)<?php if($part_page == ''){?></a><?php }?></span>
												...
												<div class="chart_star">
													...
													<!-- //star_area -->
													<?php if($part_page == ''){?><a href="/search/invest_charm/<?=$row['m_ticker']?>?pn=<?=$part_name;?>&pg=<?=$part_page;?>'" class="more">자세히 <i>>></i> </a><?php }?>
												</div>
												<!-- //chart_star -->
											</div>
										</div>
						...
						<a href="/main/service_guide" class="compet_chart_uses">
