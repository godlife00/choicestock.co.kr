            <?php include_once MR_INC_PATH.'/ticker_submenu.php'; ?>
            ...
            <div class="sub_mid bandchart_more">
                <p><i></i>종목추천&포트폴리오 운영안내 <a href="/<?=MR?>_stock/recommend/portfolio#more" class="more">자세히</a></p>                
            </div>
            ...
            <div class="sub_mid eventPicks_area">
                                ...
                                <table cellspacing="0" border="1" class="tableRanking sum_table">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <?php else :?>
                                            <a href="/<?=MR?>_stock/recommend_view/<?=$val['rc_id']?>"><?=$val['tkr_name']?><span class="ticker"><?=$val['rc_ticker']?></span></a></td>
                                            <?php endif;?>
                                            <td class="num">
                ...
                function view_more() {
                    ...
                    page += 1;
                    $.post('/<?=MR?>_stock/ajax_get_recommend_list', {'page': page}, function(res) {
                        if($.trim(res).length) {
                ...
                $(function() {
                    $('.sub_top .chart_area').on('click', function() {
                        location.href = '/<?=MR?>_stock/recommend_view/' + $(this).data('id');
                    });
                });
                </script>
                <?php endif;?>
