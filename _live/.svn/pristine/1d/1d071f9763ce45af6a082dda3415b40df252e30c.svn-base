            <div class="sub_mid latest_results">
                <div class="tabsArea">
                    <ul class="tabs tabs_two">
                        <li class="active" rel="tab1"><a href='/<?=WT?>_main/search'>관심종목</a></li>
                        <li rel="tab2">인기종목</li>
                    </ul>
                    ...
                    <div class="tab_container">
                        ...
                        <div id="tab1" class="tab_content">
                            ...
                            <div class="onestep_guide">
                                ...
                                <a href="/<?=WT?>_main/search" class="more"><span>관심종목</span><img src="/img/more_white.png" alt="더보기"></a>
...
<?php //iconv_substr($val['ticker']['tkr_name'], 0, 1, 'utf-8')?>
                                        ...
                                        <script>
                                            var value = [{
                                                data: [
                                                    ...
                                                    <?php $careful .= '<li><a href="/'.WT.'_search/summary/'.$val['ticker']['tkr_ticker'].'">'.$ticker_name.'</a></li>'."\n"?>
                                                    <?php $is_careful = TRUE?>
                                                    <?php endif;?>
                                                    <?php if($val['m_biz_total_score']>=65 && $val['ticker']['tkr_close'] < $val['m_v_fairvalue2']) :?>
                                                    <?php if($is_careful === FALSE):?>
                                                    <?php $hopeful .= '<li><a href="/'.WT.'_search/summary/'.$val['ticker']['tkr_ticker'].'">'.$ticker_name.'</a></li>'."\n"?>
                                                    <?php endif;?>
                                                    <?php endif;?>
                                                    <?php endforeach;?>
                                                ]
                                ...
                                <div class="dgtic_results">
                                    ...
                                    <!-- //caution -->
                                    <p class="nodata_guide tr_left">* 투자 유망/유의 종목은 투자매력 포인트, 밸류에이션, 재무 안전성 등을 반영한 포트폴리오 진단 알고리즘으로 평가합니다. </p>
                                </div>
                                <!-- //dgtic_results -->
                            </div>
                            <!-- //onestep_chart -->
                            ...
                            <div class="onestep_sample">
								...
								//if($this->session->userdata('user_ostype') == 'A') :?>
                                    <!--<a href="javascript:;" class="sample_box btn_free md-trigger"><strong>원스톱 진단</strong>샘플화면입니다.</a>-->
								<?php //else :?>
								<a href="#" data-modal="modal-3" class="sample_box btn_free md-trigger">
                            ...
                            <!--<div class="one_step">
                                <span class="txt">미국주식창에서 추천하는 취향저격 종목을 확인하세요</span>
                                <a href="/<?=WT?>_stock/catch_info" class="more"><span>종목 캐치</span><img src="/img/more_yel.png" alt="더보기"></a>
                            </div>-->
                        </div>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="score"><span><?=$val['m_biz_total_score']?><b>P</b> <span class="txt_guide"><img src="/img/txt_guide.png" alt="가이드보기"></span> </span>                                            
                                            <div class="guide_box show" style="display: block;">
                                                ...
                                                <ul>
                                                    <li class="list_txt">투자매력 포인트는 높을수록 매력적인 기업이며, 65P(상위 20%) 이상이면 우량 기업으로 판단합니다.</li>
                                                    <li class="list_txt">투자매력 세부 항목인 독점력, 수익성, 안전성, 성장성, 현금창출력, 배당매력으로 별점(★) 5점 만점에 3점 이상이면 각 항목을 통과한
                                                        것으로 판단합니다.</li>
                                                    <li class="list_txt">세부 항목 평가에서 별점 0~1점을 받았다면 위험 요인으로, 투자 판단시 유의해서 봐야 합니다.</li>
                                                    <li class="list_txt">성장주는 배당을 지급하지 않는 경우가 많습니다. 고성장 기업을 분석할 때는 배당 매력 점수를 제외한 4개 항목의 평가 점수로 투자 판단에
                                                        참고하시면 됩니다.</li>
                                        ...
                                        <?php else :?>
                                        <td class="prm_lock">
                                            <span><a href="/<?=WT?>_main/service"><img src="/img/prm_lock.png" alt="잠김"></a></span>
                                        </td>
                                        <?php endif;?>
                                    </tr>
                                <?php $cnt++; endforeach; ?>
