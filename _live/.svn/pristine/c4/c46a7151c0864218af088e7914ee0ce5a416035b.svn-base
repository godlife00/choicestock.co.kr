...
class Px_main extends Px_BaseMobile_Controller {
	...
	public function index()
	{
        ...
        $data['meta_title'] = '투자를 쉽고 편리하게 - 팍스초이스';
    ...
    public function ajax_save_search_history($srv='P') {
...
//echo '<pre>'; print_r($tab_stock_data);
    ...
    public function service_prm() {
		$this->common->locationhref('/'.PX.'_main/service');
		exit;
        $this->header_data['header_template'] = '16';
        $this->header_data['show_alarm'] = FALSE;
        $this->header_data['head_title'] = '서비스소개';
	...
	public function saveTicker() {
		...
		$this->common->locationhref('/'.PX.'_main/search');
		exit;
	}
}
