            ...
            <div class="sub_mid research_board">
				...
				<div class="video_tabs">
					<a href="/<?=EG?>_stock/note" class="">종목노트</a>                    
					<a href="/<?=EG?>_stock/research" class="">탐구생활</a>                    
					<a href="/<?=EG?>_stock/vod" class="active">동영상</a>                    
				</div>
            ...
            function view_more() {
                ...
                page += 1;
                $.post('/<?=EG?>_stock/ajax_get_vod_list', {'page': page}, function(res) {
                    if($.trim(res).length) {
