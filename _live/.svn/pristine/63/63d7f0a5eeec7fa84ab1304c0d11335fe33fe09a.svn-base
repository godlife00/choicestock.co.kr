...
<?php endif;?>
								<?php if($type == 'earnings') :?>
                                    <?php $in_cnt=0; foreach($list['recent_report'] as $key => $val) : ?>
										<div class="area">
											<ul class="list">
												<li class="title"><a href="/<?=EG?>_search/summary/<?=$val['tkr_ticker']?>"><?=$val['tkr_name']?></a></li>
												<li class="num">
								...
								<?php elseif($type == 'interest') :?>
									...
									<div class="area">
										<ul class="list">
											<li class="title">
												<a href="/<?=EG?>_search/summary/<?=$val['m_ticker']?>"><?=$val['ticker']['tkr_name']?></a>
									...
									<div class="area">
										<ul class="list">
											...
											<?php if($this->session->userdata('is_paid')===TRUE) :?>
												<a href="/<?=EG?>_search/summary/<?=$val['tkr_ticker']?>"><?=$val['tkr_name']?></a>
                                ...
                                <?php else :?>
									...
									<div class="area">
										<ul class="list">
											...
											<?php else :?>										
												<li class="title"><a href="/<?=EG?>_search/summary/<?=$val['m_ticker']?>"><?=$val['m_korname']?></a></li>
											<?php endif;?>
											<li class="num">
												<span><?=$price?><b>%</b></span>
											</li>
