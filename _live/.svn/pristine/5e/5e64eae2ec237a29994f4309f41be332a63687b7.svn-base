...
abstract class Mr_BaseMobile_Controller extends CI_Controller {
...
//https://mirae.choicestock.co.kr/mr_main?serviceYN=Y&customNo=SUY4UUs3M1JKTmhSTFREL0NVa1F2dz09
    }
...
//서비스소개 : "https://mirae.choicestock.co.kr/mr_main/service"  + &serviceYN="Y 또는 N" &customNo="고객번호"
//홈 :  "https://mirae.choicestock.co.kr/mr_main" + &serviceYN="Y 또는 N" &customNo="고객번호"
...
*/
    ...
    protected function payCheck(){
        if(!$this->session->userdata('is_paid')){
			...
			//echo '}';			
			echo '</script>';
            $this->common->locationhref('/mr_main');
            exit;
		}
    }
...
/* remove
                ...
                case 'member/notice':
                    ...
                    break;
remove */
                case MR.'_main/myticker':
                    $show_menu = false;
                case MR.'_main/onestop':
                case MR.'_main/search':
                    $container_class = 'sub_search schfix_inc';
                    $show_type = '2';
                    $is_searching = true;
                    $searching_title = '진단';
                    break;
                case MR.'_stock/recommend':
                    $header['header_class'] = ' h_sub';
                ...
                case MR.'_stock/recommend_view':
                    ...
                    $is_sicon = false;
                    break;
                case MR.'_stock/analysis':
                    $header['header_class'] = ' h_sub';
                    $container_class = 'sub_analysis';
                    $show_type = '2';
                    //$is_vt_banner = TRUE;
                    break;
                case MR.'_stock/analysis_view':
                    $container_class = 'sub_analysis';
                    $show_type = '2';
                    break;
                case MR.'_stock/winner':
                    $header['header_class'] = ' h_sub';
                ...
                case MR.'_stock/vod_view':
                    ...
                    $back_url = 'vod';
                    break;
                case MR.'_search/news_view':
                case MR.'_stock/research_view':
                    $container_class = 'sub_research';
                    $show_type = '2';
                    $is_headtop = true;
                    $headtop_title = '탐구생활';
                    $is_sicon = false;
                    break;
                case MR.'_stock/morning_view':
                case MR.'_stock/morning':
                ...
                case MR.'_stock/catch_info':
                    ...
                    $searching_title = '발굴';
                    break;
                case MR.'_search/primary_ticker':
                case MR.'_search/news':
                case MR.'_search/fairvalue':
                case MR.'_search/invest_charm':
                case MR.'_search/summary':
                case MR.'_search/finance_chart':
                case MR.'_search/invest':
                case MR.'_search/financials':
                case MR.'_search/dividend':
                case MR.'_search/competitor':
                    $show_type = '2';
                    ...
                    //$back_url = 'recommend';
                    break;
                case MR.'_attractiveness/attractive':
                    $header['header_class'] = ' h_sub';
                    $show_type = '2';
                ...
                case MR.'_main/menu':
                    ...
                    break;
                case MR.'_main/service':
                case MR.'_main/service_guide':
                case MR.'_main/service_prm':
                    $show_type = '3';
                    //$is_vt_banner = TRUE;
...
//remove        case 'payment/pay_free':
		...
		*/
        ...
        if( ! $return_contents) {
            ...
            $this->load->view('/'.MR.'/inc/header.php', $header);
            $this->load->view('/'.MR.'/'.$view.'.php', $data);
            $this->load->view('/'.MR.'/inc/footer.php', $footer);
        } else {

            //if($data['chkUri']!='mirae') {
            $result  = $this->load->view('/'.MR.'/inc/header.php', $header, true)."\n";
            $result .= $this->load->view('/'.MR.'/'.$view.'.php', $data, true)."\n";
            //}
            $result .= $this->load->view('/'.MR.'/inc/footer.php', $footer, true)."\n";
            return $result;
        }
    }
