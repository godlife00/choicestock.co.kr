            ...
            <div class="sub_mid attract_sub">
                ...
                function view_more() {
                    ...
                    var url = '/<?=SK?>_attractiveness/ajax_get_attractive_list';
                ...
                <?php else :?>
                <?php //$move='Y'; include_once SK_INC_PATH.'/premium_banner.php'; ?>
                <?php endif;?>
            </div> <!-- //sub_mid -->
            ...
            <div class="md-modal md-effect-3" id="modal-3">
                ...
                <div id="setting" class="setting_area">
                    ...
                    <div class="pop_con">
                        ...
                        <form id="search_form" action="/<?=SK?>_attractiveness/attractive" method="GET">
