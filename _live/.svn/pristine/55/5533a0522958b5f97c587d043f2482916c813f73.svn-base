...
<?php if($sec_ticker=='' && $pri_ticker=='') {?>
                            ...
                            <dt class="charm">종목진단
                                ...
                                <div class="guide_box _hide">
                                    ...
                                    <ul>
                                        ...
                                        <li class="list_txt">우량주 여부를 판단한 후에는 AI적정주가로 저평가 여부를 확인하세요.</li>
                                    </ul>
                                </div>
                            </dt>
							</dt>
                ...
                <div class="investCharm_area">
                    ...
                    <div class="tab_diagnosis_area">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="star_area">
                                            <div class="starRev">
											<?=$this->common->countingStar($mri_data['m_future_stars']);?>
                                            </div>
                                        </div>
                                        <!-- //star_area -->
                                    </td>
                                    <td class="num">
										<?php if($part_page!='et') :?><a href="/attractiveness/attractive?sort=future&netincome=all&marketcap=over100billion"><?php endif;?><span>상위 <?=$future_rank_rate?>%</span><?php if($part_page!='et') :?></a><?php endif;?>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="title">
                                    ...
                                    <td>
                                        <div class="star_area">
                                            <div class="starRev">
											<?=$this->common->countingStar($mri_data['m_biz_moat_stars']);?>
                                            </div>
                                        </div>
                                        <!-- //star_area -->
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="star_area">
                                            <div class="starRev">
											<?=$this->common->countingStar($mri_data['m_biz_safety_stars']);?>
                                            </div>
                                        </div>
                                        <!-- //star_area -->
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="star_area">
                                            <div class="starRev">
											<?=$this->common->countingStar($mri_data['m_biz_growth_stars']);?>
                                            </div>
                                        </div>
                                        <!-- //star_area -->
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="star_area">
                                            <div class="starRev">
											<?=$this->common->countingStar($mri_data['m_biz_cashflow_stars']);?>
                                            </div>
                                        </div>
                                        <!-- //star_area -->
                                    </td>
                            ...
                            <div class="alloca_star">
                                ...
                                <div class="alloca_box">
                                    <div class="small_star">
                                        ...
                                        <div class="star_area">
                                            <div class="starRev">
											<?=$this->common->countingStar($indavg_scores['m_future_stars']);?>
                                            </div>
                                        </div>
                                        <!-- //star_area -->
                                    </div>
                                ...
                                <div class="alloca_box">
                                    <div class="small_star">
                                        ...
                                        <span>
                                            <div class="star_area">
                                                <div class="starRev">
												<?=$this->common->countingStar($avg_scores['m_future_stars']);?>
                                                </div>
                                            </div>
                                            <!-- //star_area -->
                                        </span>
							...
							<div class="alloca_star">
								...
								<div class="alloca_box">
									<div class="small_star">
										...
										<div class="star_area">
											<div class="starRev">
											<?=$this->common->countingStar($indavg_scores['m_biz_moat_stars']);?>
											</div>
										</div>
										<!-- //star_area -->
									</div>
								...
								<div class="alloca_box">
									<div class="small_star">
										...
										<span>
											<div class="star_area">
												<div class="starRev">
												<?=$this->common->countingStar($avg_scores['m_biz_moat_stars']);?>
												</div>
											</div>
											<!-- //star_area -->
										</span>
							...
							<div class="alloca_star">
								...
								<div class="alloca_box">
									<div class="small_star">
										...
										<div class="star_area">
											<div class="starRev">
											<?=$this->common->countingStar($indavg_scores['m_biz_safety_stars']);?>
											</div>
										</div>
										<!-- //star_area -->
									</div>
								...
								<div class="alloca_box">
									<div class="small_star">
										...
										<span>
											<div class="star_area">
												<div class="starRev">
												<?=$this->common->countingStar($avg_scores['m_biz_safety_stars']);?>
												</div>
											</div>
											<!-- //star_area -->
										</span>
							...
							<div class="alloca_star">
								...
								<div class="alloca_box">
									<div class="small_star">
										...
										<div class="star_area">
											<div class="starRev">
											<?=$this->common->countingStar($indavg_scores['m_biz_growth_stars']);?>
											</div>
										</div>
										<!-- //star_area -->
									</div>
								...
								<div class="alloca_box">
									<div class="small_star">
										...
										<span>
											<div class="star_area">
												<div class="starRev">
												<?=$this->common->countingStar($avg_scores['m_biz_growth_stars']);?>
												</div>
											</div>
											<!-- //star_area -->
										</span>
							...
							<div class="alloca_star">
								...
								<div class="alloca_box">
									<div class="small_star">
										...
										<div class="star_area">
											<div class="starRev">
											<?=$this->common->countingStar($indavg_scores['m_biz_cashflow_stars']);?>
											</div>
										</div>
										<!-- //star_area -->
									</div>
								...
								<div class="alloca_box">
									<div class="small_star">
										...
										<span>
											<div class="star_area">
												<div class="starRev">
												<?=$this->common->countingStar($avg_scores['m_biz_cashflow_stars']);?>
												</div>
											</div>
											<!-- //star_area -->
										</span>
									...
									<div class="swiper-slide">
										<div class="chart_area">
											<div class="chartData">
												...
												<span class="chart_name"><?php if($part_page == ''){?><a href="/search/summary/<?=$row['m_ticker'];?>?pn=<?=$part_name;?>&pg=<?=$part_page;?>"><?php }?><?=$row['m_korname']?> (<?=$row['m_ticker']?>)<?php if($part_page == ''){?></a><?php }?></span>
												
												<div class="chart_star">
													<div class="star_area">
														<span class="title">미래성장성</span>
														<div class="starRev">
														<?=$this->common->countingStar($row['m_future_stars']);?>
														</div>
													</div>
													<!-- //star_area -->
													<div class="star_area">
														...
														<div class="starRev">
														<?=$this->common->countingStar($row['m_biz_moat_stars']);?>
														</div>
													</div>
													<!-- //star_area -->
													<div class="star_area">
														...
														<div class="starRev">
														<?=$this->common->countingStar($row['m_biz_safety_stars']);?>
														</div>
													</div>
													<!-- //star_area -->
													<div class="star_area">
														...
														<div class="starRev">
														<?=$this->common->countingStar($row['m_biz_growth_stars']);?>
														</div>
													</div>
													<!-- //star_area -->
													<div class="star_area">
														...
														<div class="starRev">
														<?=$this->common->countingStar($row['m_biz_cashflow_stars']);?>
														</div>
													</div>
													<!-- //star_area -->
													<?php if($part_page == ''){?><a href="/search/summary/<?=$row['m_ticker']?>?pn=<?=$part_name;?>&pg=<?=$part_page;?>" class="more">자세히 <i>>></i> </a><?php }?>
												</div>
												<!-- //chart_star -->
											</div>
										</div>
						...
						<a href="https://www.datahero.co.kr/choicestockus-faq" class="compet_chart_uses">
