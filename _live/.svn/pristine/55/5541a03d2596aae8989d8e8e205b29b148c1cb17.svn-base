			<?php include_once PX_INC_PATH.'/find_submenu.php'; ?>

			<form name="catchForm" method="post" action="/<?=PX?>_stock/set_catch">
			...
			<?php if($this->session->userdata('is_paid')===TRUE) :?>
                ...
                <div class="chart_catch">
                    <div class="data_area">
                        <h2 class="title"><a href="/<?=PX?>_search/invest_charm/<?=$ticker['tkr_ticker']?>"><?=$ticker['tkr_name']?></a></h2>
                        <ul class="info">
                        ...
                        <ul class="info_icon">
							...
							<li><a href="/<?=PX?>_stock/recipe/dividend">배당주</a></li>
							<?php endif; ?>
							<?php if($ticker['mri']['m_biz_growth_score'] >= 16) : ?>
							<li><a href="/<?=PX?>_stock/recipe/growth">성장주</a></li>
							<?php endif; ?>
							<?php if($ticker['mri']['m_biz_moat_score'] >= 16) : ?>
							<li><a href="/<?=PX?>_stock/recipe/moat">가치주</a></li>
							<?php endif; ?>
					...
					<span class="same_selt"><a href="/<?=PX?>_search/invest_charm/<?=$choice_ticker?>"><?=$choice_name?></a>와(과) 같은 업종입니다</span>
					<?php endif;?>
                </div>
                <!-- //chart_catch -->
				<?php $idx++; endforeach;?>
					<?php if($is_next === true) :?>
					<div class="next"><a href="/<?=PX?>_stock/add_catch?mode=auto&idx=<?=$idx?>&page=1" class="nextPage">다음 페이지</a></div>
					<?php endif;?>
				<?php else :?>
				...
				<div class="prm_div weeks_free">
					<div class="box">
						<?php if(date('Ymd')<'20210118') :?>
							<div class="left">
								<p class="title"><i></i>신용카드 정기결제 1/18 오픈 예정 </p>
							</div>
						<?php else :?>
							<div class="left">
							...
							<div class="right">
								<p><a href="javascript:fnPay();" class="btn_free">첫달 3,000원<i></i></a></p>
							</div>
						<?php endif;?>
					</div>
				</div>
        ...
        <div id="catch_cncl" class="setting_area">
            ...
            <div class="pop_con">
                ...
                <div class="btnArea payBtn">
                    ...
                    <a href="javascript:;" class="btn btn_save terms_btn btn_payCan" onClick="javascript:fnCatchSave();">확인<i></i></a>
                </div>
