...
function SubSearchAllocLineChart(obj_id, value, params, moneyunit) {
	moneyunit = moneyunit || '%';
	var chart_colors = '';
	chart_colors = ["#00AECE", "#545872", "#d3d3d3"];
...
function MainSpiderChart(obj_id, value) {
    Highcharts.chart(obj_id, {
        ...
        xAxis: {
            ...
            categories: ['미래 성장성', '수익성', '사업 독점력', '재무 안전성', '현금 창출력'],
            tickmarkPlacement: 'on',
            lineWidth: 0,
            labels: {
                enabled: false
...
/* 적정주가밴드차트 */
function FairValueBandChart(obj_id, min, max, dates, close, fairvalue5, fairvalue4, fairvalue3, fairvalue2, fairvalue1) {
...
*/
		...
		lang: {
			noData: "밸류에시션에 필요한 데이터가 충분하지 않아<BR> 적정주가를 제시하지 않습니다.",                
		},
