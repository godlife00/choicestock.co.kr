                        ...
                        <table cellspacing="0" border="1" class="tableRanking table_alloca">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="num">
                                        <?php if($part_page!='et') :?><a href="/<?=HN?>_attractiveness/attractive?sort=future&netincome=all&marketcap=over100billion"><?php endif;?><span>상위 <?=$future_rank_rate?>%</span><?php if($part_page!='et') :?></a><?php endif;?>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="title">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="chart_area">
                                            <div class="chartData">
                                                ...
                                                <span class="chart_name"><?php if($part_page == ''){?><a href="/<?=HN?>_search/summary/<?=$row['m_ticker'];?>"><?php }?><?=$row['m_korname']?> (<?=$row['m_ticker']?>)<?php if($part_page == ''){?></a><?php }?></span>
                                                ...
                                                <div class="chart_star">
                                                    ...
                                                    <!-- //star_area -->
                                                    <?php if($part_page == ''){?><a href="/<?=HN?>_search/summary/<?=$row['m_ticker']?>" class="more">자세히 <i>>></i> </a><?php }?>
                                                </div>
                                                <!-- //chart_star -->
                                            </div>
                                        </div>
...
<?php }else{?>
        ...
        <div class="sub_mid nondata">
            <p class="nodata_guide"><strong><?=$sec_ticker;?></strong>의 상세 기업정보는 <strong><?php if($part_page == ''){?><a href="/<?=HN?>_search/summary/<?=$pri_ticker?>"><?php }?><?=$pri_ticker?><?php if($part_page == ''){?></a><?php }?></strong> 종목에서 확인할 수 있습니다.</p>
        </div>
        <!-- //sub_mid nondata -->
<?php }?>
<?php }else{?>
