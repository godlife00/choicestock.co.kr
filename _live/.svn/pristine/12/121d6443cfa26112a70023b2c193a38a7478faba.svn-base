		...
		<div class="investCharm_area">
			<div class="tab_diagnosis_area">
                <div class="financecachart_area">
                    <div class="tabs_menu">
                        <span onclick="location.href='/search/finance_chart/<?=$ticker_code?>/MRT?pn=<?=$part_name;?>&pg=<?=$part_page;?>&pm=m'" class="<?=$dimension == 'MRT' ? 'active' : ''?>">연환산</span>
                        <span onclick="location.href='/search/finance_chart/<?=$ticker_code?>/MRY?pn=<?=$part_name;?>&pg=<?=$part_page;?>&pm=m'" class="<?=$dimension == 'MRY' ? 'active' : ''?>">연간</span>
                        <span onclick="location.href='/search/finance_chart/<?=$ticker_code?>/MRQ?pn=<?=$part_name;?>&pg=<?=$part_page;?>&pm=m'" class="<?=$dimension == 'MRQ' ? 'active' : ''?>">분기</span>
                    </div>                    
                    ...
                    <div class="chart_area">
                        <div class="box">
							...
							//2021.3.22 추가
							if($dimension=='MRT' || $dimension=='MRQ') {
								$vchart_data['salesincome']['data']['L1_column_revenue'] = array_slice($vchart_data['salesincome']['data']['L1_column_revenue'], 0, 10);
								$vchart_data['salesincome']['data']['R1_line_opinc'] = array_slice($vchart_data['salesincome']['data']['R1_line_opinc'], 0, 10);
								$vchart_data['salesincome']['data']['R2_line_netinc'] = array_slice($vchart_data['salesincome']['data']['R2_line_netinc'], 0, 10);
							}
                        ...
                        <div class="box">
							...
							//2021.3.22 추가
							if($dimension=='MRT' || $dimension=='MRQ') {
								$vchart_data['margin']['data']['L1_line_opmargin'] = array_slice($vchart_data['margin']['data']['L1_line_opmargin'], 0, 10);
								$vchart_data['margin']['data']['L2_line_netmargin'] = array_slice($vchart_data['margin']['data']['L2_line_netmargin'], 0, 10);
							}
						...
						<?php if($this->session->userdata('is_paid')===FALSE) :?>
							<?php if(!strstr($_SERVER['HTTP_USER_AGENT'], 'choicestock')) :?>
								<!-- 구글 에드센스 이익률차트, ROE/PBR차트 하단 -->
								<div style="margin:30px 15px 0; text-align: center;">                
									<!-- 디스플레이(사각) -->    
                        ...
                        <div class="box">
							...
							//2021.3.22 추가
							if($dimension=='MRT' || $dimension=='MRQ') {
								$vchart_data['debtcr']['data']['L1_line_de'] = array_slice($vchart_data['debtcr']['data']['L1_line_de'], 0, 10);
								$vchart_data['debtcr']['data']['R1_line_currentratio'] = array_slice($vchart_data['debtcr']['data']['R1_line_currentratio'], 0, 10);
							}
                        ...
                        <div class="box">
							...
							//2021.3.22 추가
							if($dimension=='MRT' || $dimension=='MRQ') {
								$vchart_data['dividend']['data']['R1_line_divyield'] = array_slice($vchart_data['dividend']['data']['R1_line_divyield'], 0, 10);
								$vchart_data['dividend']['data']['L1_column_dps'] = array_slice($vchart_data['dividend']['data']['L1_column_dps'], 0, 10);
							}
                        ...
                        <div class="box">
							...
							//2021.3.22 추가
							if($dimension=='MRT' || $dimension=='MRQ') {
								$vchart_data['roepbr']['data']['L1_line_roe'] = array_slice($vchart_data['roepbr']['data']['L1_line_roe'], 0, 10);
								$vchart_data['roepbr']['data']['R1_line_pb'] = array_slice($vchart_data['roepbr']['data']['R1_line_pb'], 0, 10);
							}
                        ...
                        <div class="box">
							...
							//2021.3.22 추가
							if($dimension=='MRT' || $dimension=='MRQ') {
								$vchart_data['turnoverdays']['data']['L1_line_receiveturnoverdays'] = array_slice($vchart_data['turnoverdays']['data']['L1_line_receiveturnoverdays'], 0, 10);
								$vchart_data['turnoverdays']['data']['L2_line_inventoryturnoverdays'] = array_slice($vchart_data['turnoverdays']['data']['L2_line_inventoryturnoverdays'], 0, 10);
								$vchart_data['turnoverdays']['data']['L3_line_payableturnoverdays'] = array_slice($vchart_data['turnoverdays']['data']['L3_line_payableturnoverdays'], 0, 10);
							}
                        ...
                        <div class="box">
							...
							//2021.3.22 추가
							if($dimension=='MRT' || $dimension=='MRQ') {
								$vchart_data['cashflow']['data']['L1_line_ncfo'] = array_slice($vchart_data['cashflow']['data']['L1_line_ncfo'], 0, 10);
								$vchart_data['cashflow']['data']['L2_line_ncfi'] = array_slice($vchart_data['cashflow']['data']['L2_line_ncfi'], 0, 10);
								$vchart_data['cashflow']['data']['L3_line_ncff'] = array_slice($vchart_data['cashflow']['data']['L3_line_ncff'], 0, 10);
							}
                        ...
                        <div class="box">
							...
							//2021.3.22 추가
							if($dimension=='MRT' || $dimension=='MRQ') {
								$vchart_data['per']['data']['L1_line_pe'] = array_slice($vchart_data['per']['data']['L1_line_pe'], 0, 10);
							}
                        ...
                        <div class="box">
							...
							//2021.3.22 추가
							if($dimension=='MRT' || $dimension=='MRQ') {
								$vchart_data['priceeps']['data']['L1_line_epsdil'] = array_slice($vchart_data['priceeps']['data']['L1_line_epsdil'], 0, 10);
								$vchart_data['priceeps']['data']['R1_line_close'] = array_slice($vchart_data['priceeps']['data']['R1_line_close'], 0, 10);
							}
                        ...
                        <div class="box">
							...
							//2021.3.22 추가
							if($dimension=='MRT' || $dimension=='MRQ') {
								$vchart_data['pbr']['data']['L1_line_pb'] = array_slice($vchart_data['pbr']['data']['L1_line_pb'], 0, 10);
							}
                        ...
                        <div class="box">
							...
							//2021.3.22 추가
							if($dimension=='MRT' || $dimension=='MRQ') {
								$vchart_data['pricebps']['data']['L1_line_bvps'] = array_slice($vchart_data['pricebps']['data']['L1_line_bvps'], 0, 10);
								$vchart_data['pricebps']['data']['L2_line_close'] = array_slice($vchart_data['pricebps']['data']['L2_line_close'], 0, 10);
							}
                        ...
                        <div class="box">
                            <h3 class="title">주가매출액배수(PSR)</h3>
                            <div id="containerfinance1_12" class="containerfinance1"></div>
							<?php

							//2021.3.22 추가
							if($dimension=='MRT' || $dimension=='MRQ') {
								$vchart_data['psr']['data']['L1_line_ps'] = array_slice($vchart_data['psr']['data']['L1_line_ps'], 0, 10);
							}
							//if($dimension == 'MRT' && isset($vchart_data_mry) && $is_adr) {
							//	$psr_key = array_keys(array_reverse($vchart_data_mry['psr']['data']['L1_line_ps']));
							//	$l1_ps = array_values(array_reverse($vchart_data_mry['psr']['data']['L1_line_ps']));
							//}
							//else {
								$psr_key = array_keys(array_reverse($vchart_data['psr']['data']['L1_line_ps']));
								$l1_ps = array_values(array_reverse($vchart_data['psr']['data']['L1_line_ps']));
							//}

							$l1_ps_cnt = count($l1_ps);
							$l1_ps_new = array();
							foreach($l1_ps as $eVal) {
								if($eVal == 0 ) $l1_ps_cnt--;
								$l1_ps_new[] = $eVal;
							}
							if($l1_ps_cnt==0) $l1_ps_new = array();
							?>
                            <script>
							var params = [<?php foreach($psr_key as $val) echo "'".substr($val,0,$dp_year)."',";?>];
                            var value = [{
                                    name: '주가매출액배수',
                                    type: 'line',
                                    //data: [<?=implode(',',array_values(array_reverse($vchart_data['psr']['data']['L1_line_ps'])))?>],
                                    data: [<?=implode(',',array_values($l1_ps_new))?>],
                                }];
                            SubSearchCharmFiChart10('containerfinance1_12', value, params);
                            </script>
                            <!-- 종목검색 - 종목진단 - 재무 차트 id = containerfinance1 -->
                            <div class="summary_guide small">
                                <!-- div 사이즈는 big, small  -->
                                <p class="guide">주가매출액배수(PSR)는 순이익이 매출액의 몇 배에 거래되는 지를 나타냅니다. 이 지표도 다른 밸류에이션 지표처럼 낮을수록 저평가 됐다는 것을 뜻합니다. 이 지표는 일시적인 적자기업이나 경기변동형 기업의 밸류에이션 수준을 확인할 때 유용합니다.<br/><br/> 켄 피셔는 PSR이 1.5 이하면 싸고, 3~6배까지 올랐다면 매도 시점이라고 조언합니다.
                                </p>
                            </div>
                        </div>
                        
                        <div class="box">
                            <h3 class="title">주가와 주당매출액</h3>
                            <div id="containerfinance1_13" class="containerfinance1"></div>
							<?php

							//2021.3.22 추가
							if($dimension=='MRT' || $dimension=='MRQ') {
								$vchart_data['pricesps']['data']['L1_line_sps'] = array_slice($vchart_data['pricesps']['data']['L1_line_sps'], 0, 10);
								$vchart_data['pricesps']['data']['L2_line_close'] = array_slice($vchart_data['pricesps']['data']['L2_line_close'], 0, 10);
							}

							//if($dimension == 'MRT' && isset($vchart_data_mry) && $is_adr) {
							//	$sps_key = array_keys(array_reverse($vchart_data_mry['pricesps']['data']['L1_line_sps']));
							//	$l1_sps = array_values(array_reverse($vchart_data_mry['pricesps']['data']['L1_line_sps']));
							//}
							//else {
								$sps_key = array_keys(array_reverse($vchart_data['pricesps']['data']['L1_line_sps']));
								$l1_sps = array_values(array_reverse($vchart_data['pricesps']['data']['L1_line_sps']));
							//}

							$l1_sps_cnt = count($l1_sps);
							$l1_sps_new = array();
							foreach($l1_sps as $eVal) {
								if($eVal == 0 ) $l1_sps_cnt--;
								$l1_sps_new[] = $eVal;
							}
							if($l1_sps_cnt==0) $l1_sps_new = array();

							//if($dimension == 'MRT' && isset($vchart_data_mry) && $is_adr) {
							//	$l2_cl = array_values(array_reverse($vchart_data_mry['pricesps']['data']['L2_line_close']));
							//}
							//else {
								$l2_cl = array_values(array_reverse($vchart_data['pricesps']['data']['L2_line_close']));
							//}
							...
							?>
                            <script>
							var params = [<?php foreach($sps_key as $val) echo "'".substr($val,0,$dp_year)."',";?>];
                            var value = [{
                                    name: '주당매출액',
                                    type: 'line',
                                    //data: [<?=implode(',',array_values(array_reverse($vchart_data['pricebps']['data']['L1_line_bvps'])))?>],
                                    data: [<?=implode(',',array_values($l1_sps_new))?>],
                                }, {
                                    name: '주가',
                                    type: 'line',
                                    yAxis: 1,
                            ...
                            SubSearchCharmFiChart11('containerfinance1_13', value, params);
                            </script>

                            <!-- 종목검색 - 종목진단 - 재무 차트 id = containerfinance1 -->
                            <div class="summary_guide small">
                                <!-- div 사이즈는 big, small  -->
                                <p class="guide">주가와 주당매출액의 추이를 보여주는 차트입니다. 주당매출액은 기업의 매출액을 주식수로 나눈 값입니다. 주가와 주당매출액도 일반적으로 같은 방향으로 움직입니다.<br/><br/> 적자 등으로 인해 순이익이 마이너스(-)인 기업의 주가수익배수(PER)나 주가현금흐름배수(PCR)로 밸류에이션을 측정하기에는 한계가 있을때 PSR 지표를 활용합니다.<br/><br/> 경기변동형 기업이나 턴 어라운드 기업의 밸류에이션을 가늠할때도 유용합니다.
                                </p>
                            </div>
                        </div>
...
<?php }else{?>
		...
		<div class="sub_mid nondata">
			<p class="nodata_guide"><strong><?=$sec_ticker;?></strong>의 상세 기업정보는 <strong><a href="/search/summary/<?=$pri_ticker?>?pn=<?=$part_name;?>&pg=<?=$part_page;?>"><?=$pri_ticker?></a></strong> 종목에서 확인할 수 있습니다.</p>
		</div>
		<!-- //sub_mid nondata -->
<?php }?>