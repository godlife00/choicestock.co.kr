...
class Vod_mjm_tb_model extends MY_Model {
    ...
    protected $emptycheck_keys = array(
        'vm_admin_id' 		=> '작성자 value is empty.',
        'vm_title' 		=> '제목 value is empty.',
        'vm_content' 		=> '내용 value is empty.',
        'vm_display_date' 		=> '표출날짜 value is empty.',
        //'vm_view_count' 		=> '조회수 value is empty.',
        'vm_created_at' 		=> '등록일 value is empty.',
        'vm_updated_at' 		=> '수정일 value is empty.'
        );
    ...
    protected $enumcheck_keys = array(
        'vm_is_active'		=> array(
                            'enum'	=> array ('YES','NO'),
                            'message'	=> 'vm_is_active value is not valid.'
                            )
        );
    ...
    protected function __filter($params) {
        $params['vm_created_at'] = date('Y-m-d H:i:s');
