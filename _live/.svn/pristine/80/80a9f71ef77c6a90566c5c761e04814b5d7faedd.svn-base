            ...
            <div class="main_top recommend_area">
				...
				<a href="/<?=HN?>_stock/recommend">종목추천</a></h3>
                ...
                ?>
                    <div class="chart_area">
                        <div class="chartData">
                            ...
                            <?php else :?>
                            <a href="/<?=HN?>_stock/recommend_view/<?=$val['rc_id']?>"><?=$val['ticker']['tkr_name']?>
                            <?php endif;?>
                            </a></h4>
                            <ul class="info">
                ...
                <div class="one_step">
                    ...
                    <a href="/<?=HN?>_main/onestop" class="more"><span>원스톱 진단</span><img src="/img/more_yel.png" alt="더보기"></a>
                </div>
            </div>
            ...
            <div class="main_mid event_recipe">
				<?php if($this->session->userdata('is_paid')===TRUE) :?>
                <h3 class="title"><a href="/<?=HN?>_stock/recipe_intro">투자레시피</a></h3>
                <a href="/<?=HN?>_stock/recipe_intro" class="more"><img src="/img/more_Black.png" alt="더보기"></a>
				<?php else :?>
                        ...
                        <div id="tab1" class="tab_content">
                            <div class="tableth_box">
                                ...
                                <table cellspacing="0" border="0" class="tableRanking type_2Line">
                                    ...
                                    <?php if($rc>4) break;?>
                                        <tr>
                                            <td class="title t_short"><a href="/<?=HN?>_search/invest_charm/<?=$val['tkr_ticker']?>"><?=$val['tkr_name']?><span class="ticker"><?=$val['tkr_ticker']?></span></a></td>
                                            <td class="num">
                            ...
                            <div class="tableth_box">
                                ...
                                <table cellspacing="0" border="0" class="tableRanking type_2Line">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="title"><a href="/<?=HN?>_search/invest_charm/<?=$row['m_ticker']?>"><?=$row['m_korname']?><span class="ticker"><?=$row['m_ticker']?></span></a>
                                            </td>
                                            <td class="num">
