...
require_once dirname(__FILE__).'/mr_base_mobile.php';
class Mr_search extends Mr_BaseMobile_Controller {
    ...
    public function index() {
        $this->common->locationhref('/'.MR.'_main');
    }
    ...
    private function _general_data($ticker, $dimension='MRY', $option=array()) {
        ...
        if(sizeof($recom_data) > 0) {
            ...
            $data['recom_link'] = '/'.MR.'_stock/recommend_view/'.$recom['rc_id'];
        }
    ...
    public function news($ticker='') {
        ...
        $data['ticker_header'] = $this->load->view('/'.MR.'/search/ticker_header', $data, true);
    ...
    public function ajax_get_news_list() {
        ...
        echo $this->load->view('/'.MR.'/search/news_list', $list_data, true);
    }
    ...
    public function news_view($ticker='', $no=0) {
        ...
        $this->header_data['back_url'] = '/'.MR.'_search/news/'.$ticker;
        //$this->header_data['back_url'] = '/';
...
*/
    ...
    public function alloca($ticker='AAPL') {
        $this->common->locationhref('/'.MR.'_search/dividend/'.$ticker);
		exit;
	}
