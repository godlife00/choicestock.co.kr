			...
			<div class="main_mid game_area">
				<h3 class="title"><a href="/<?=MR?>_stock/winner">승부주</a> <span class="remark">스탁히어로 알고리즘 종목추천</span></h3>
				<a href="/<?=MR?>_stock/winner" class="more"><img src="/img/more_Black.png" alt="더보기"></a>
				<div class="list_area">
							...
							<div class="swiper-slide">
								<div class="area">
									...
									<?php if($this->session->userdata('is_paid')===TRUE || $win<1) :?>
										<li class="title"><a href="/<?=MR?>_search/summary/<?=$winner['win_ticker']?>"><?=$winner['tkr_name']?></a></li>
