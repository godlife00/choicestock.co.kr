...
class News_tb_model extends MY_Model {
    ...
    protected $emptycheck_keys = array(
        'n_writer_id' 		=> '작성자 value is empty.',
        'n_title' 		=> '제목 value is empty.',
        'n_display_date' 		=> '표출날짜 value is empty.',
        //'vm_view_count' 		=> '조회수 value is empty.',
        'n_created_at' 		=> '등록일 value is empty.',
        'n_updated_at' 		=> '수정일 value is empty.'
        );
    ...
    protected $enumcheck_keys = array(
        'n_is_active'		=> array(
                            'enum'	=> array ('YES','NO'),
                            'message'	=> 'n_is_active value is not valid.'
                            )
        );
    ...
    public static $pay_map = array(
        'N' => '무료',
        'Y' => '유료',
    );
    public function getPayMap() {
        return self::$pay_map;
    }
...
/*
        ...
        $this->notify_tb_model->doSyncNotify('UPDATE', $options);
 */
 ...
 */
    ...
    protected function __filter($params) {
        $params['n_created_at'] = date('Y-m-d H:i:s');
        $params['n_updated_at'] = date('Y-m-d H:i:s');
        return $params;
    }
