...
//print_r($data['mrt_list']);
    ...
    public function analysis() {
        ...
        $data['content_html'] = $this->load->view('/'.PX.'/stock/analysis_list', $list_data, true);
        $this->header_data['header_template'] = '2';
    ...
    public function ajax_get_analysis_list() {
        ...
        echo $this->load->view('/'.PX.'/stock/analysis_list', $list_data, true);
