...
<head>
    ...
    <meta name="robots" content="투자를 쉽고 편리하게 - 미주미초이스">
    ...
    <!-- js -->
    <script src="/js/<?=($is_soft === true) ? 'kw_':''?>globalstock.js?v=<?=filemtime(APP_PATH.'/js/globalstock.js')?>"></script>
    <script src="/js/<?=KW?>_globalstock.dev.js?v=<?=filemtime(APP_PATH.'/js/'.KW.'_globalstock.dev.js')?>"></script>
    ...
    <div id="wrap">
        ...
        <header>
            <div class="nav_wrapper">
                <a class="menu-logo" href="http://usstockrecommendation.com"><img src="/img/logo2.png"></a>
                ...
                <nav id="menu" class="menu">
                    <ul class="dropdown">
                        <li><a href="http://usstockrecommendation.com">서비스소개</a></li>
                        <li><a href="http://usstockrecommendation.com/kiwoom/listStock">종목추천</a></li>
                        <li><a href="#" onclick="goApply()">신청/해지</a></li>
                        <li><a href="#" onclick="goAlimInfo()">알림정보</a></li>
                        <li><a href="#" onclick="goAlimReg()">알림신청</a></li>
                        <li><a href="http://usstockrecommendation.com/about/index">동영상</a></li>
                    </ul>
                </nav>
            </div>
        </header>
        <div class="main_wrap">
            <div class="page_title tabs_link">
                <h2><a href="http://usstockrecommendation.com/kiwoom/listStock">미주미추천</a></h2>                    
                <h2><a href="/<?=KW?>_stock/recommend"<?=($soft_menu == 'recommend') ? ' class="active"':''?>>AI추천</a></h2>
                <h2><a href="/<?=KW?>_attractiveness/attractive?sort=total&netincome=all&marketcap=over100billion"<?=($soft_menu == 'attractive') ? 'class="active"':''?>>종목발굴</a></h2>                   
            </div>               
        </div>
        <style>
            .page_title.tabs_link {background:#1154ab;}
            .page_title.tabs_link h2 {display: inline-block; width: calc(100% / 3 - 3px);}
            .page_title.tabs_link h2 a {color:#ffffff; font-size:16px; opacity: 0.6;}
            .page_title.tabs_link h2 a.active {color:#ffffff; font-size:16px; opacity: 1;}            
        </style>
        <!-- //미주미 해더 추가 끝 -->
        <?php endif;?>
        ...
        <div id="header" class="header main_hdr">
            ...
            <div class="headerTop">
                <h1 class="headerLogo"><span>미주미초이스</span></h1>
                <?php if($this->session->userdata('is_paid')===TRUE) :?>
                <div class="top_btn">
                    <a href="/<?=KW?>_main/menu" class="btn_memu"><img src="/img/icon_menu2.png" alt="메뉴"></a>
                </div>
                <?php endif;?>
                <!-- //top_btn -->
				<!-- //hm -->
                <div class="hm">
                    <a href="/<?=KW?>_stock/morning" class="alarm_briefing"><img src="/img/alarm_briefing.svg"></a>
                </div>
                <!-- //hm -->
            </div>
            <!-- //headerTop -->
            ...
            <div class="main_searching">
                ...
                <div class="searchArea">
                    <form action=""  name="topsearch" onsubmit="var v = $('#autocomplete_list li a._on span.schCode').html(); if(v.length > 0 && $('#autocomplete_list').get(0).children.length > 0) { this.action='/<?=KW?>_search/summary/'+v; setSearchHistory(v); return true; }; return false;">
                        <fieldset>
        ...
        <div id="header" class="header">
            <div class="headerTop">
                <h1 class="headerLogo"><span><a href="/<?=KW?>_main"><?=$headtop_title?></a></span></h1>
                <?php if($this->session->userdata('is_paid')===TRUE) :?>
					<?php if($back_url=='menu') :?>
					<a href="/<?=KW?>_main/menu" class="his_back"><img src="/img/icon_back.svg" alt="뒤로가기"></a>
					<?php elseif($back_url=='recommend') :?>
					<a href="/<?=KW?>_stock/recommend" class="his_back"><img src="/img/icon_back.svg" alt="뒤로가기"></a>
					<?php elseif($back_url=='vod') :?>
					<a href="/<?=KW?>_stock/vod" class="his_back"><img src="/img/icon_back.svg" alt="뒤로가기"></a>
					<?php elseif($back_url=='none') :?>
					<?php else :?>
					<a href="javascript:history.back(-1);" class="his_back"><img src="/img/icon_back.svg" alt="뒤로가기"></a>
					<?php endif;?>
				<?php else :?>
					<a href="/<?=KW?>_main" class="his_back"><img src="/img/icon_back.svg" alt="뒤로가기"></a>
				<?php endif;?>

                <?php if($is_sicon === true):?>
                <div class="hm">
                    <?php if($is_soft === true) :?>
                        <a href="#" class="go_sch"><img src="/img/icon_search.svg" alt="검색하기"></a>
                    <?php else :?>
                        <a href="/<?=KW?>_main/search" class="go_sch"><img src="/img/icon_search.svg" alt="검색하기"></a>
                    <?php endif;?>
                </div>
                <?php endif;?>
                <?php if($is_morning === true):?>
                <a href="/<?=KW?>_stock/morning" class="go_briefing"><img src="/img/btn_briefing.png" alt="모닝브리핑 바로가기"></a>
                <?php endif;?>
