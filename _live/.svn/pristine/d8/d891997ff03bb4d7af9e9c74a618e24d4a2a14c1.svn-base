...
//print_r($data['mrt_list']);
    ...
    public function analysis() {
        ...
        $data['content_html'] = $this->load->view('/'.X1.'/stock/analysis_list', $list_data, true);
        $this->header_data['header_template'] = '2';
    ...
    public function ajax_get_analysis_list() {
        ...
        echo $this->load->view('/'.X1.'/stock/analysis_list', $list_data, true);
    ...
    public function recipe($type='dividend') {
        ...
        $data['score_content_html'] = $this->load->view('/'.X1.'/stock/recipe_list.php', array('type' => $type, 'list' => $list), true);
		$data['type'] = $type;
    ...
    public function ajax_get_recipe_list() {
        ...
        $content_html = $this->load->view('/'.X1.'/stock/recipe_list.php', array('type' => $type, 'list' => $list), true);
        echo $content_html;
        return;
    }
				...
				foreach($ticker_list as $key => $ticker) {
					...
					if($ticker['tkr_ticker']!='') {
						...
						if(sizeof($analysis_data) > 0) {
							...
							$ticker_info[$ticker['tkr_ticker']]['analysis_link'] = '/'.X1.'_stock/analysis_view/'.$analy['an_id'];
						}
						*/
