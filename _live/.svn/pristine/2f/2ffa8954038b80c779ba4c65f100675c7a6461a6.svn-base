...
class Eg_search extends Eg_BaseMobile_Controller {
    ...
    public function ajax_get_news_list() {
        ...
        echo $this->load->view('/'.EG.'/search/news_list', $list_data, true);
    }
    ...
    public function news_view($ticker='', $no=0) {
        ...
        $this->header_data['back_url'] = '/'.EG.'_search/news/'.$ticker;
        //$this->header_data['back_url'] = '/';
...
*/
    ...
    public function alloca($ticker='AAPL') {
        $this->common->locationhref('/'.EG.'_search/dividend/'.$ticker);
        exit;
    }
