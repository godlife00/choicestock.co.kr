...
class Notify_tb_model extends MY_Model {
    ...
    public static $table_map_new = array(
        'recommend_tb' => array( 'title'=>'종목추천 &#38; 포트폴리오', 'class'=>'recom'),
        'vod_mjm_tb' => array( 'title'=>'종목노트', 'class'=>'note'),
        'explore_tb' => array( 'title'=>'종목노트', 'class'=>'note'),
        'push_tb' => array( 'title'=>'이벤트 &#47; 알림', 'class'=>'event'),
        'custom' => array( 'title'=>'이벤트 &#47; 알림', 'class'=>'event'),
    );
    public function getTableNewMap() {
        return self::$table_map_new;
    }

	public static $table_map = array(
        'recommend_tb' => '종목추천',
        'analysis_tb' => '종목분석',
        'explore_tb' => '미국주식 종목노트',
        'master_tb' => '대가의 종목',
        'vod_mjm_tb' => '미국주식 종목노트',
        'push_tb' => '서비스알림',
        'wt_notify_tb' => '프로모션/안내 ',
        'custom' => '알림',
    );
