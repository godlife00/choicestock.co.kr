        ...
        ?>
            <div class="sub_top view">
                <div class="chart_area">
                    <div class="chartData">
                        <h2 class="title" title="<?=$rc_data['ticker']['tkr_name_en']?>"><a href="/<?=PX?>_search/invest_charm/<?=$rc_data['rc_ticker']?>"><?=$rc_data['ticker']['tkr_name']?></a></h2>
                        <a href="/<?=PX?>_search/invest_charm/<?=$rc_data['rc_ticker']?>" class="more"><img src="/img/more_Black.png" alt="더보기"></a>
                        <ul class="info">
            ...
            <div class="sub_mid">
                <div class="tabsArea">
                    ...
                    <div class="tab_container">
						...
						<?php $rc_data['rc_invest_point'] = str_replace('www.choicestock.co.kr/stock','paxnet.choicestock.co.kr/'.PX.'_stock',$rc_data['rc_invest_point'])?>
						<?php $rc_data['rc_invest_point'] = str_replace('www.choicestock.co.kr/search','paxnet.choicestock.co.kr/'.PX.'_search',$rc_data['rc_invest_point'])?>
                        ...
                        <div id="tab2" class="tab_content">
                            ...
                            <div class="data_table">
                                ...
                                <a href="/<?=PX?>_search/invest/<?=$rc_data['rc_ticker']?>" class="more"><img src="/img/more_Black.png" alt="더보기"></a>
                                <!-- 수익성(연환산) -->
                                <div>
                                    <table cellspacing="0" border="1" class="tableRanking">
                                        <colgroup>
