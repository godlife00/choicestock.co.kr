...
class Kw_search extends Kw_BaseMobile_Controller {
    ...
    public function index() {
        $this->common->locationhref('/'.KW.'_main');
    }
    ...
    private function _general_data($ticker, $dimension='MRY', $option=array()) {
        ...
        if(sizeof($recom_data) > 0) {
            ...
            $data['recom_link'] = '/'.KW.'_stock/recommend_view/'.$recom['rc_id'];
        }
    ...
    public function news($ticker='') {
        ...
        $data['ticker_header'] = $this->load->view('/'.KW.'/search/ticker_header', $data, true);

        $data['meta_title'] = $data['ticker']['tkr_name'].' '.$ticker.'('.$data['ticker']['tkr_name_en'].') | 뉴스 - 미주미초이스';
    ...
    public function ajax_get_news_list() {
        ...
        echo $this->load->view('/'.KW.'/search/news_list', $list_data, true);
    }
    ...
    public function news_view($ticker='', $no=0) {
        ...
        $this->header_data['back_url'] = '/'.KW.'_search/news/'.$ticker;
        //$this->header_data['back_url'] = '/';
		$data['meta_title'] = $row['n_title'].' | 뉴스 - 미주미초이스';
        //$data['meta_title'] = $data['ticker']['tkr_name'].' '.$ticker.'('.$data['ticker']['tkr_name_en'].') | 뉴스 - 미주미초이스';
    ...
    public function fairvalue($ticker='AAPL') {
        ...
        $data['meta_title'] = $data['ticker']['tkr_name'].' '.$ticker.'('.$data['ticker']['tkr_name_en'].') | 적정주가 - 미주미초이스';
...
//$data['ticker_unit'] = 0;
        ...
        $data['meta_title'] = $data['ticker']['tkr_name'].' '.$ticker.'('.$data['ticker']['tkr_name_en'].') | 개요 - 미주미초이스';
...
/*차트*/
        ...
        $data['meta_title'] = $data['ticker']['tkr_name'].' '.$ticker.' | 투자매력 - 미주미초이스';
    ...
    public function competitor($ticker) {
        ...
        $data['meta_title'] = $data['ticker']['tkr_name'].' '.$ticker.' | 경쟁사 - 미주미초이스';
    ...
    public function finance_chart($ticker, $dimension='MRY') {
        ...
        */
        ...
        $data['meta_title'] = $data['ticker']['tkr_name'].' '.$ticker.' | 재무차트 - 미주미초이스';
...
*/
    ...
    public function financials($ticker, $dimension='MRT') {
        ...
        */
        ...
        $data['meta_title'] = $data['ticker']['tkr_name'].' '.$ticker.'('.$data['ticker']['tkr_name_en'].') | 재무제표 - 미주미초이스';
    ...
    public function invest($ticker, $dimension='MRT') {
        ...
        $data['meta_title'] = $data['ticker']['tkr_name'].' '.$ticker.'('.$data['ticker']['tkr_name_en'].') | 투자지표 - 미주미초이스';
    ...
    public function alloca($ticker='AAPL') {
        $this->common->locationhref('/'.KW.'_search/dividend/'.$ticker);
		exit;
	}
    ...
    public function dividend($ticker='AAPL') {
        ...
        $data['meta_title'] = $data['ticker']['tkr_name'].' '.$ticker.' | 배당 - 미주미초이스';
