...
*/
	...
	*/
    ...
    public function invest_charm($ticker, $dimension='MRY') {
		...
		//ADR Preferred', 'ADR Secondary', 'Canadian Preferred', 'Canadian Secondary', 'Domestic Preferred', 'Domestic Secondary'
		//Primary Domestic 처리
...
/*차트*/
        ...
        $data['meta_title'] = $data['ticker']['tkr_name'].' '.$ticker.'('.$data['ticker']['tkr_name_en'].') 주가 | 투자매력 - 초이스스탁US';
...
//$data['ticker_unit'] = 0;
        ...
        $data['meta_title'] = $data['ticker']['tkr_name'].' '.$ticker.'('.$data['ticker']['tkr_name_en'].') | 기업개요 - 초이스스탁US';
...
*/
    ...
    public function getSpiderData($date='') {
		...
		echo '<table border=1>';
		echo '<tr><td>Ticker</td><td>Korname</td><td>Exchange</td><td>Sector</td><td>Industry</td><td>Biz Growth Score</td><td>Biz Safety Score</td><td>Biz Cashflow Score</td><td>Biz Moat Score</td><td>Biz Dividend Score</td><td>Biz Total Score</td><td>Star Growth Score</td><td>Star Safety Score</td><td>Star Cashflow Score</td><td>Star Moat Score</td><td>Star Dividend Score</td><td>Star Total Score</td><td>ranking</td><td>highrank</td><td>Sep Date</td><td>Close</td><td>Marketcap</td><td>Pb</td><td>Pe</td><td>Ps</td><td>Roe</td><td>Divyield</td><td>Date</td></tr>';
		foreach($mri_list as $key=>$val) {
			echo '<tr><td>'.$val['m_ticker'].'</td><td>'.$val['m_korname'].'</td><td>'.$val['m_exchange'].'</td><td>'.$val['m_sector'].'</td><td>'.$val['m_industry'].'</td><td>'.$val['m_biz_growth_score'].'</td><td>'.$val['m_biz_safety_score'].'</td><td>'.$val['m_biz_cashflow_score'].'</td><td>'.$val['m_biz_moat_score'].'</td><td>'.$val['m_biz_dividend_score'].'</td><td>'.$val['m_biz_total_score'].'</td><td>'.$val['m_biz_growth_stars'].'</td><td>'.$val['m_biz_safety_stars'].'</td><td>'.$val['m_biz_cashflow_stars'].'</td><td>'.$val['m_biz_moat_stars'].'</td><td>'.$val['m_biz_dividend_stars'].'</td><td>'.($val['m_biz_growth_stars']+$val['m_biz_safety_stars']+$val['m_biz_cashflow_stars']+$val['m_biz_moat_stars']+$val['m_biz_dividend_stars']).'</td><td>'.$val['m_ranking'].'</td><td>'.$val['m_highrank'].'</td><td>'.$val['m_sep_date'].'</td><td>'.$val['m_close'].'</td><td>'.$val['m_marketcap'].'</td><td>'.$val['m_pbr'].'</td><td>'.$val['m_per'].'</td><td>'.$val['m_psr'].'</td><td>'.$val['m_roe'].'</td><td>'.$val['m_divyield'].'</td><td>'.$val['m_date'].'</td></tr>';
		}
		echo '</table>';
    }
}
