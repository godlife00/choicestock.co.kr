		...
		<div class="investCharm_area">
			<div class="tab_diagnosis_area">
                <div class="financecachart_area">
                    <div class="tabs_menu">
                        <span onclick="location.href='/<?=X1?>_search/finance_chart/<?=$ticker_code?>/MRT?pn=<?=$part_name;?>&pg=<?=$part_page;?>&pm=m'" class="<?=$dimension == 'MRT' ? 'active' : ''?>">연환산</span>
                        <span onclick="location.href='/<?=X1?>_search/finance_chart/<?=$ticker_code?>/MRY?pn=<?=$part_name;?>&pg=<?=$part_page;?>&pm=m'" class="<?=$dimension == 'MRY' ? 'active' : ''?>">연간</span>
                        <span onclick="location.href='/<?=X1?>_search/finance_chart/<?=$ticker_code?>/MRQ?pn=<?=$part_name;?>&pg=<?=$part_page;?>&pm=m'" class="<?=$dimension == 'MRQ' ? 'active' : ''?>">분기</span>
                    </div>                    
...
<?php }else{?>
		...
		<div class="sub_mid nondata">
			<p class="nodata_guide"><strong><?=$sec_ticker;?></strong>의 상세 기업정보는 <strong><a href="/<?=X1?>_search/invest_charm/<?=$pri_ticker?>?pn=<?=$part_name;?>&pg=<?=$part_page;?>"><?=$pri_ticker?></a></strong> 종목에서 확인할 수 있습니다.</p>
		</div>
		<!-- //sub_mid nondata -->
<?php }?>