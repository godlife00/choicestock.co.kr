...
<head>
    ...
    <script src="/js/<?=MR?>_globalstock.dev.js?v=<?=filemtime(APP_PATH.'/js/'.MR.'_globalstock.dev.js')?>"></script>
    ...
    <div id="wrap">
        ...
        <div id="header" class="header main_hdr">
            ...
            <div class="headerTop">
                ...
                <div class="top_btn">
                    <a href="/<?=MR?>_main/menu" class="btn_memu"><img src="/img/icon_menu2.png" alt="메뉴"></a>
                </div>
                <?php endif;?>
                <!-- //top_btn -->
				<!-- //hm -->
                <div class="hm">
                    <a href="/<?=MR?>_stock/morning" class="alarm_briefing"><img src="/img/alarm_briefing.svg"></a>
                </div>
                <!-- //hm -->
            </div>
            <!-- //headerTop -->
            ...
            <div class="main_searching">
                ...
                <div class="searchArea">
                    <form action=""  name="topsearch" onsubmit="var v = $('#autocomplete_list li a._on span.schCode').html(); if(v.length > 0 && $('#autocomplete_list').get(0).children.length > 0) { this.action='/<?=MR?>_search/summary/'+v; setSearchHistory(v); return true; }; return false;">
                        <fieldset>
        ...
        <div id="header" class="header">
            <div class="headerTop">
                ...
                <?php if($this->session->userdata('is_paid')===TRUE) :?>
					...
					<a href="/<?=MR?>_main/menu" class="his_back"><img src="/img/icon_back.svg" alt="뒤로가기"></a>
					<?php elseif($back_url=='recommend') :?>
					<a href="/<?=MR?>_stock/recommend" class="his_back"><img src="/img/icon_back.svg" alt="뒤로가기"></a>
					<?php elseif($back_url=='none') :?>
					<?php else :?>
					<a href="javascript:history.back(-1);" class="his_back"><img src="/img/icon_back.svg" alt="뒤로가기"></a>
					<?php endif;?>
				<?php else :?>
					<a href="/<?=MR?>_main" class="his_back"><img src="/img/icon_back.svg" alt="뒤로가기"></a>
				<?php endif;?>

                <?php if($is_sicon === true):?>
                <div class="hm">
                    <a href="/<?=MR?>_main/search" class="go_sch"><img src="/img/icon_search.svg" alt="검색하기"></a>
                </div>
                <?php endif;?>
                <?php if($is_morning === true):?>
                <a href="/<?=MR?>_stock/morning" class="go_briefing"><img src="/img/btn_briefing.png" alt="모닝브리핑 바로가기"></a>
                <?php endif;?>
