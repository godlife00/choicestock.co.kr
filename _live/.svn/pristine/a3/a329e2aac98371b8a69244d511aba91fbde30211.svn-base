...
<?php //iconv_substr($val['ticker']['tkr_name'], 0, 1, 'utf-8')?>
                                        ...
                                        <script>
                                            var value = [{
                                                data: [
                                                    ...
                                                    <?php $careful .= '<li><a href="/'.HT.'_search/summary/'.$val['ticker']['tkr_ticker'].'">'.$ticker_name.'</a></li>'."\n"?>
                                                    <?php $is_careful = TRUE?>
                                                    <?php endif;?>
                                                    <?php if($val['m_biz_total_score']>=65 && $val['ticker']['tkr_close'] < $val['m_v_fairvalue2']) :?>
                                                    <?php if($is_careful === FALSE):?>
                                                    <?php $hopeful .= '<li><a href="/'.HT.'_search/summary/'.$val['ticker']['tkr_ticker'].'">'.$ticker_name.'</a></li>'."\n"?>
                                                    <?php endif;?>
                                                    <?php endif;?>
                                                    <?php endforeach;?>
                                                ]
                            ...
                            <table cellspacing="0" border="0" class="tableRanking type_2Line">
                                ...
                                ?>
                                    <tr>
                                        <td class="title"><a href="/<?=HT?>_search/summary/<?=$val['ticker']['tkr_ticker']?>"><?=$val['ticker']['tkr_name']?><span class="ticker"><?=$val['ticker']['tkr_ticker']?></span></a></td>
                                        <td class="num">
