                                ...
                                <div class="chart_area">
                                    <div class="chartData">
                                        <div class="left">
											...
											<a href="javascript:fnLogin();"><?=iconv_substr($r['ticker']['tkr_name'], 0, 1, 'utf-8')?><span class="remark"><div class="txt_filter size_M"><i></i><i></i><i></i><i></i></div></span>
											<?php else :?>
											<a href="/<?=X1?>_stock/recommend_view/<?=$r['rc_id']?>"><?=$r['ticker']['tkr_name']?>
											<?php endif;?>
                                            ...
                                            <ul class="info">
												...
												<?php else :?>
												<a href="/<?=X1?>_stock/recommend_view/<?=$r['rc_id']?>">
												<?php endif;?>												
...
<?php }else{?>
									...
									?>
                                        <tr>
											...
											<?php else :?>
											<td class="prm_lock"><span><img src="/img/prm_lock_mint.png" alt="잠김"></span></td>
											<?php endif;?>                                            
											<td class="num">
