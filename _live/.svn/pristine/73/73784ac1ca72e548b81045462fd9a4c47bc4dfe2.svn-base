            <div class="view_con">
                <div class="top">
                    ...
                    <a href="/<?=X1?>_stock/vod" class="go_list">목록보기</a>
                </div>
                <div class="mid">
            ...
            <div class="popularity">
                ...
                <ul class="lst_type">
                    ...
                    <li>
                        <dl class="lst_type2">
                            <dt class="tit"><a href="/<?=X1?>_stock/vod_view/<?=$mjm['vm_id']?>"><strong><?=nl2br($mjm['vm_title'])?></strong></a></dt>
                            <?php if(strlen($mjm['vm_main_thumbnail']) > 0) : ?>
                            <dd class="photo"><a href="/<?=X1?>_stock/vod_view/<?=$mjm['vm_id']?>"><img src="https://hero.datahero.co.kr<?=$mjm['vm_main_thumbnail']?>" alt=""></a></dd>
                            <?php endif; ?>
                        </dl>
                    </li>
                    <?php endforeach; ?>
