...
class Search_log_tb_model extends MY_Model {
	...
	protected $emptycheck_keys = array(
		...
		'sl_user_id' 		=> 'sl_user_id value is empty.',
		'sl_ticker' 		=> 'sl_ticker value is empty.',
		'sl_created_at' 		=> 'sl_created_at value is empty.'
		);
	...
	protected function __filter($params) {
        $params['sl_user_id'] = 0;
        $params['sl_created_at'] = date('Y-m-d H:i:s');
		return $params;
	}
